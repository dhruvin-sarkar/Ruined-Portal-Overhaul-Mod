...
implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundAddEntityPacket(Entity entity, ServerEntity serverEntity, int i) {
        this(entity.getId(), entity.getUUID(), serverEntity.getPositionBase().x(), serverEntity.getPositionBase().y(), serverEntity.getPositionBase().z(), serverEntity.getLastSentXRot(), serverEntity.getLastSentYRot(), entity.getType(), i, serverEntity.getLastSentMovement(), serverEntity.getLastSentYHeadRot());
    }
