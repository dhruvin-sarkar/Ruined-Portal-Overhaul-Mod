...
{
    public static final MapCodec<StorageDataSource> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("storage").forGetter(StorageDataSource::id)).apply((Applicative)instance, StorageDataSource::new));
