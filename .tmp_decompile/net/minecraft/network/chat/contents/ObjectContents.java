...
public record ObjectContents(ObjectInfo contents) implements ComponentContents
{
    ...
    public static final MapCodec<ObjectContents> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ObjectInfos.CODEC.forGetter(ObjectContents::contents)).apply((Applicative)instance, ObjectContents::new));
