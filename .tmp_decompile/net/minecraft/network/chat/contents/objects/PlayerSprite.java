...
{
    public static final MapCodec<PlayerSprite> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ResolvableProfile.CODEC.fieldOf("player").forGetter(PlayerSprite::player), (App)Codec.BOOL.optionalFieldOf("hat", (Object)true).forGetter(PlayerSprite::hat)).apply((Applicative)instance, PlayerSprite::new));
