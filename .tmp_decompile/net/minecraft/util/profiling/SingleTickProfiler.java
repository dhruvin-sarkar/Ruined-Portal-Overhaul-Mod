...
public class SingleTickProfiler {
    ...
    public static @Nullable SingleTickProfiler createTickProfiler(String string) {
        if (SharedConstants.DEBUG_MONITOR_TICK_TIMES) {
            return new SingleTickProfiler(Util.timeSource, string, SharedConstants.MAXIMUM_TICK_TIME_NANOS);
        }
        return null;
    }
