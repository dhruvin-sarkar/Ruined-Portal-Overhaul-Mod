...
implements ProfileCollector {
    ...
    public void pop() {
        ...
        if (n > WARNING_TIME_NANOS && !this.suppressWarnings.getAsBoolean()) {
    ...
    public void incrementCounter(String string, int i) {
        this.getCurrentEntry().counters.addTo((Object)string, (long)i);
    }

    @Override
    public void incrementCounter(Supplier<String> supplier, int i) {
        this.getCurrentEntry().counters.addTo((Object)supplier.get(), (long)i);
    }
    ...
    @Override
    public @Nullable PathEntry getEntry(String string) {
