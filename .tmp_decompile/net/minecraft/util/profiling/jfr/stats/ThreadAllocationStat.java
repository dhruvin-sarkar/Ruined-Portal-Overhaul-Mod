...
public record ThreadAllocationStat(Instant timestamp, String threadName, long totalBytes) {
    ...
    public static Summary summary(List<ThreadAllocationStat> list2) {
        ...
        map2.forEach((string, list) -> {
            ...
            ThreadAllocationStat threadAllocationStat = (ThreadAllocationStat)((Object)((Object)list.get(0)));
            ThreadAllocationStat threadAllocationStat2 = (ThreadAllocationStat)((Object)((Object)list.get(list.size() - 1)));
