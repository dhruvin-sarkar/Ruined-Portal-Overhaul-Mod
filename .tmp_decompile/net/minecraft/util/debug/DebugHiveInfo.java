...
public record DebugHiveInfo(Block type, int occupantCount, int honeyLevel, boolean sedated) {
    ...
    public static DebugHiveInfo pack(BeehiveBlockEntity beehiveBlockEntity) {
        return new DebugHiveInfo(beehiveBlockEntity.getBlockState().getBlock(), beehiveBlockEntity.getOccupantCount(), BeehiveBlockEntity.getHoneyLevel(beehiveBlockEntity.getBlockState()), beehiveBlockEntity.isSedated());
    }
}
