...
public class StringDecomposer {
    ...
    public static boolean iterateFormatted(FormattedText formattedText, Style style2, FormattedCharSink formattedCharSink) {
        return formattedText.visit((style, string) -> StringDecomposer.iterateFormatted(string, 0, style, formattedCharSink) ? Optional.empty() : STOP_ITERATION, style2).isEmpty();
    }
