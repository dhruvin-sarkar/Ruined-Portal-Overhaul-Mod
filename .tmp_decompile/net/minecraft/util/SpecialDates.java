...
public class SpecialDates {
    ...
    public static final List<MonthDay> CHRISTMAS_RANGE = List.of((Object)MonthDay.of(Month.DECEMBER, 24), (Object)MonthDay.of(Month.DECEMBER, 25), (Object)MonthDay.of(Month.DECEMBER, 26));
