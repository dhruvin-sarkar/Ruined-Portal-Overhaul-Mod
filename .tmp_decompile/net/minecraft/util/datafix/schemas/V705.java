...
extends NamespacedSchema {
    ...
    protected static final Hook.HookFunction ADD_NAMES = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> dynamicOps, T object) {
            return V99.addNames(new Dynamic(dynamicOps, object), V704.ITEM_TO_BLOCKENTITY, ITEM_TO_ENTITY);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register((Map)map, "minecraft:commandblock_minecart", string -> DSL.optionalFields((String)"DisplayTile", (TypeTemplate)References.BLOCK_NAME.in(schema), (String)"LastOutput", (TypeTemplate)References.TEXT_COMPONENT.in(schema)));
        ...
        schema.register((Map)map, "minecraft:enderman", string -> DSL.optionalFields((String)"carried", (TypeTemplate)References.BLOCK_NAME.in(schema)));
