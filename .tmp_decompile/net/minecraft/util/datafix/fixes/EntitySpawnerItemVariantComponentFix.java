...
extends DataFix {
    ...
    private static <T> Dynamic<T> fixTropicalFishBucket(Dynamic<T> dynamic2, Dynamic<T> dynamic22) {
        ...
        String string = EntitySpawnerItemVariantComponentFix.getPattern(i);
        String string2 = EntitySpawnerItemVariantComponentFix.getBaseColor(i);
        String string3 = EntitySpawnerItemVariantComponentFix.getPatternColor(i);
