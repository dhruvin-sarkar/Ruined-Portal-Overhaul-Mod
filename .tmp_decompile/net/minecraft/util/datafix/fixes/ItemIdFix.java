...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), typed -> typed.update(opticFinder, type2, either -> (Pair)either.map(integer -> Pair.of((Object)References.ITEM_NAME.typeName(), (Object)ItemIdFix.getItem(integer)), pair -> pair)));
    }
}
