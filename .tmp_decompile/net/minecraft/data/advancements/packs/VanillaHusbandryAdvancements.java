...
implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer) {
        ...
        HolderGetter holderLookup = provider.lookupOrThrow(Registries.FROG_VARIANT);
        HolderGetter holderLookup2 = provider.lookupOrThrow(Registries.CAT_VARIANT);
        HolderGetter holderLookup3 = provider.lookupOrThrow(Registries.WOLF_VARIANT);
        HolderGetter registryLookup = provider.lookupOrThrow(Registries.ENCHANTMENT);
        AdvancementHolder advancementHolder = Advancement.Builder.advancement().display(Blocks.HAY_BLOCK, (Component)Component.translatable("advancements.husbandry.root.title"), (Component)Component.translatable("advancements.husbandry.root.description"), Identifier.withDefaultNamespace("gui/advancements/backgrounds/husbandry"), AdvancementType.TASK, false, false, false).addCriterion("consumed_item", ConsumeItemTrigger.TriggerInstance.usedItem()).save(consumer, "husbandry/root");
        ...
        VanillaHusbandryAdvancements.addCatVariants(Advancement.Builder.advancement(), (HolderLookup<CatVariant>)holderLookup2).parent(advancementHolder4).display(Items.COD, (Component)Component.translatable("advancements.husbandry.complete_catalogue.title"), (Component)Component.translatable("advancements.husbandry.complete_catalogue.description"), null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(consumer, "husbandry/complete_catalogue");
        VanillaHusbandryAdvancements.addTamedWolfVariants(Advancement.Builder.advancement(), (HolderLookup<WolfVariant>)holderLookup3).parent(advancementHolder4).display(Items.BONE, (Component)Component.translatable("advancements.husbandry.whole_pack.title"), (Component)Component.translatable("advancements.husbandry.whole_pack.description"), null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(consumer, "husbandry/whole_pack");
        ...
        Advancement.Builder.advancement().parent(advancementHolder).addCriterion("silk_touch_nest", BeeNestDestroyedTrigger.TriggerInstance.destroyedBeeNest(Blocks.BEE_NEST, ItemPredicate.Builder.item().withComponents(DataComponentMatchers.Builder.components().partial(DataComponentPredicates.ENCHANTMENTS, EnchantmentsPredicate.enchantments(List.of((Object)((Object)new EnchantmentPredicate(registryLookup.getOrThrow(Enchantments.SILK_TOUCH), MinMaxBounds.Ints.atLeast(1)))))).build()), MinMaxBounds.Ints.exactly(3))).display(Blocks.BEE_NEST, (Component)Component.translatable("advancements.husbandry.silk_touch_nest.title"), (Component)Component.translatable("advancements.husbandry.silk_touch_nest.description"), null, AdvancementType.TASK, true, true, false).save(consumer, "husbandry/silk_touch_nest");
    ...
    private static Advancement.Builder addLeashedFrogVariants(HolderGetter<EntityType<?>> holderGetter, HolderGetter<Item> holderGetter2, HolderLookup<FrogVariant> holderLookup, Advancement.Builder builder) {
        VanillaHusbandryAdvancements.sortedVariants(holderLookup).forEach(reference -> builder.addCriterion(reference.key().identifier().toString(), PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(holderGetter2, Items.LEAD), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(holderGetter, EntityType.FROG).components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.FROG_VARIANT, reference)).build()))))));
        return builder;
    }
