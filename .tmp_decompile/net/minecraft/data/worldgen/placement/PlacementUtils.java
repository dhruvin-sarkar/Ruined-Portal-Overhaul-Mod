...
public class PlacementUtils {
    ...
    public static void register(BootstrapContext<PlacedFeature> bootstrapContext, ResourceKey<PlacedFeature> resourceKey, Holder<ConfiguredFeature<?, ?>> holder, PlacementModifier ... placementModifiers) {
        PlacementUtils.register(bootstrapContext, resourceKey, holder, List.of((Object[])placementModifiers));
    }
    ...
    public static PlacementModifier countExtra(int i, float f, int j) {
        ...
        WeightedList<IntProvider> weightedList = WeightedList.builder().add(ConstantInt.of(i), (int)g - 1).add(ConstantInt.of(i + j), 1).build();
    ...
    public static Holder<PlacedFeature> inlinePlaced(Holder<ConfiguredFeature<?, ?>> holder, PlacementModifier ... placementModifiers) {
        return Holder.direct(new PlacedFeature(holder, List.of((Object[])placementModifiers)));
    }
