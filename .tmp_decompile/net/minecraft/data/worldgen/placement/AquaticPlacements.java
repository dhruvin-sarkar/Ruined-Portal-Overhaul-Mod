...
public class AquaticPlacements {
    ...
    private static List<PlacementModifier> seagrassPlacement(int i) {
        return List.of((Object)InSquarePlacement.spread(), (Object)PlacementUtils.HEIGHTMAP_TOP_SOLID, (Object)CountPlacement.of(i), (Object)BiomeFilter.biome());
    }
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapContext) {
        ...
        PlacementUtils.register(bootstrapContext, SEAGRASS_WARM, reference, AquaticPlacements.seagrassPlacement(80));
        PlacementUtils.register(bootstrapContext, SEAGRASS_NORMAL, reference, AquaticPlacements.seagrassPlacement(48));
        PlacementUtils.register(bootstrapContext, SEAGRASS_COLD, reference, AquaticPlacements.seagrassPlacement(32));
        PlacementUtils.register(bootstrapContext, SEAGRASS_RIVER, reference2, AquaticPlacements.seagrassPlacement(48));
        PlacementUtils.register(bootstrapContext, SEAGRASS_SWAMP, reference3, AquaticPlacements.seagrassPlacement(64));
        PlacementUtils.register(bootstrapContext, SEAGRASS_DEEP_WARM, reference4, AquaticPlacements.seagrassPlacement(80));
        PlacementUtils.register(bootstrapContext, SEAGRASS_DEEP, reference4, AquaticPlacements.seagrassPlacement(48));
        PlacementUtils.register(bootstrapContext, SEAGRASS_DEEP_COLD, reference4, AquaticPlacements.seagrassPlacement(40));
        PlacementUtils.register(bootstrapContext, SEA_PICKLE, reference5, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstrapContext, KELP_COLD, reference6, NoiseBasedCountPlacement.of(120, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstrapContext, KELP_WARM, reference6, NoiseBasedCountPlacement.of(80, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        PlacementUtils.register(bootstrapContext, WARM_OCEAN_VEGETATION, reference7, NoiseBasedCountPlacement.of(20, 400.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
    }
}
