...
public class VillagePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapContext) {
        ...
        PlacementUtils.register(bootstrapContext, PILE_HAY_VILLAGE, holder, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, PILE_MELON_VILLAGE, holder2, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, PILE_SNOW_VILLAGE, holder3, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, PILE_ICE_VILLAGE, holder4, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, PILE_PUMPKIN_VILLAGE, holder5, new PlacementModifier[0]);
        ...
        PlacementUtils.register(bootstrapContext, PATCH_CACTUS_VILLAGE, holder10, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, FLOWER_PLAIN_VILLAGE, holder11, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, PATCH_TAIGA_GRASS_VILLAGE, holder12, new PlacementModifier[0]);
        PlacementUtils.register(bootstrapContext, PATCH_BERRY_BUSH_VILLAGE, holder13, new PlacementModifier[0]);
    }
}
