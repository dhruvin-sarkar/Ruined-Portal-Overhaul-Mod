...
public class BiomeDefaultFeatures {
    ...
    public static void commonSpawns(MobSpawnSettings.Builder builder, int i) {
        ...
        BiomeDefaultFeatures.monsters(builder, 95, 5, 0, i, false);
    }
    ...
    public static void swampSpawns(MobSpawnSettings.Builder builder, int i) {
        BiomeDefaultFeatures.commonSpawns(builder, i);
    ...
    public static void snowySpawns(MobSpawnSettings.Builder builder, boolean bl) {
        ...
        BiomeDefaultFeatures.caveSpawns(builder);
        BiomeDefaultFeatures.monsters(builder, bl ? 90 : 95, 5, bl ? 5 : 0, 20, false);
    ...
    public static void monsters(MobSpawnSettings.Builder builder, int i, int j, int k, int l, boolean bl) {
        builder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SPIDER, 4, 4));
        builder.addSpawn(MobCategory.MONSTER, i, new MobSpawnSettings.SpawnerData(bl ? EntityType.DROWNED : EntityType.ZOMBIE, 4, 4));
        builder.addSpawn(MobCategory.MONSTER, j, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_VILLAGER, 1, 1));
        if (k > 0) {
            builder.addSpawn(MobCategory.MONSTER, k, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_HORSE, 1, 1));
        }
        builder.addSpawn(MobCategory.MONSTER, l, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 4, 4));
