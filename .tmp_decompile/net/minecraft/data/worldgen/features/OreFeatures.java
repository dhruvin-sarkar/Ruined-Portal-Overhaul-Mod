...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
        ...
        List list = List.of((Object)OreConfiguration.target(ruleTest2, Blocks.IRON_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_IRON_ORE.defaultBlockState()));
        List list2 = List.of((Object)OreConfiguration.target(ruleTest2, Blocks.GOLD_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_GOLD_ORE.defaultBlockState()));
        List list3 = List.of((Object)OreConfiguration.target(ruleTest2, Blocks.DIAMOND_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_DIAMOND_ORE.defaultBlockState()));
        List list4 = List.of((Object)OreConfiguration.target(ruleTest2, Blocks.LAPIS_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_LAPIS_ORE.defaultBlockState()));
        List list5 = List.of((Object)OreConfiguration.target(ruleTest2, Blocks.COPPER_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_COPPER_ORE.defaultBlockState()));
        List list6 = List.of((Object)OreConfiguration.target(ruleTest2, Blocks.COAL_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_COAL_ORE.defaultBlockState()));
        ...
        FeatureUtils.register(bootstrapContext, ORE_REDSTONE, Feature.ORE, new OreConfiguration(List.of((Object)OreConfiguration.target(ruleTest2, Blocks.REDSTONE_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())), 8));
        ...
        FeatureUtils.register(bootstrapContext, ORE_INFESTED, Feature.ORE, new OreConfiguration(List.of((Object)OreConfiguration.target(ruleTest2, Blocks.INFESTED_STONE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.INFESTED_DEEPSLATE.defaultBlockState())), 9));
        FeatureUtils.register(bootstrapContext, ORE_EMERALD, Feature.ORE, new OreConfiguration(List.of((Object)OreConfiguration.target(ruleTest2, Blocks.EMERALD_ORE.defaultBlockState()), (Object)OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())), 3));
        FeatureUtils.register(bootstrapContext, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration(ruleTest5, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0f));
        FeatureUtils.register(bootstrapContext, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration(ruleTest5, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0f));
