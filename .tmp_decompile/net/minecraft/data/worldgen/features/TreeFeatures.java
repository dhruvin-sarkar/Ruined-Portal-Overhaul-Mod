...
public class TreeFeatures {
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenBirch(int i) {
        return TreeFeatures.createFallenTrees(Blocks.BIRCH_LOG, 5, i);
    }
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenTrees(Block block, int i, int j) {
        return new FallenTreeConfiguration.FallenTreeConfigurationBuilder(BlockStateProvider.simple(block), UniformInt.of(i, j)).logDecorators((List<TreeDecorator>)ImmutableList.of((Object)new AttachedToLogsDecorator(0.1f, new WeightedStateProvider(WeightedList.builder().add(Blocks.RED_MUSHROOM.defaultBlockState(), 2).add(Blocks.BROWN_MUSHROOM.defaultBlockState(), 1)), List.of((Object)Direction.UP))));
    }
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
        ...
        FeatureUtils.register(bootstrapContext, CRIMSON_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockPredicate, false));
        FeatureUtils.register(bootstrapContext, CRIMSON_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockPredicate, true));
        FeatureUtils.register(bootstrapContext, WARPED_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockPredicate, false));
        FeatureUtils.register(bootstrapContext, WARPED_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), blockPredicate, true));
        FeatureUtils.register(bootstrapContext, HUGE_BROWN_MUSHROOM, Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState)((BlockState)Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, true)).setValue(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState)((BlockState)Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, false)).setValue(HugeMushroomBlock.DOWN, false)), 3));
        FeatureUtils.register(bootstrapContext, HUGE_RED_MUSHROOM, Feature.HUGE_RED_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState)Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState)((BlockState)Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, false)).setValue(HugeMushroomBlock.DOWN, false)), 2));
        ...
        FeatureUtils.register(bootstrapContext, BIRCH, Feature.TREE, TreeFeatures.createBirch().build());
        FeatureUtils.register(bootstrapContext, ACACIA, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.ACACIA_LOG), new ForkingTrunkPlacer(5, 2, 2), BlockStateProvider.simple(Blocks.ACACIA_LEAVES), new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2)).ignoreVines().build());
        FeatureUtils.register(bootstrapContext, CHERRY, Feature.TREE, TreeFeatures.cherry().build());
        FeatureUtils.register(bootstrapContext, CHERRY_BEES_005, Feature.TREE, TreeFeatures.cherry().decorators(List.of((Object)beehiveDecorator4)).build());
        ...
        FeatureUtils.register(bootstrapContext, PINE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new StraightTrunkPlacer(6, 4, 0), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new PineFoliagePlacer(ConstantInt.of(1), ConstantInt.of(1), UniformInt.of(3, 4)), new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().build());
        FeatureUtils.register(bootstrapContext, JUNGLE_TREE, Feature.TREE, TreeFeatures.createJungleTree().decorators((List<TreeDecorator>)ImmutableList.of((Object)new CocoaDecorator(0.2f), (Object)TrunkVineDecorator.INSTANCE, (Object)new LeaveVineDecorator(0.25f))).ignoreVines().build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK, Feature.TREE, TreeFeatures.createFancyOak().build());
        FeatureUtils.register(bootstrapContext, JUNGLE_TREE_NO_VINE, Feature.TREE, TreeFeatures.createJungleTree().ignoreVines().build());
        ...
        FeatureUtils.register(bootstrapContext, MEGA_SPRUCE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new GiantTrunkPlacer(13, 2, 14), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(13, 17)), new TwoLayersFeatureSize(1, 1, 2)).decorators((List<TreeDecorator>)ImmutableList.of((Object)new AlterGroundDecorator(BlockStateProvider.simple(Blocks.PODZOL)))).build());
        FeatureUtils.register(bootstrapContext, MEGA_PINE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new GiantTrunkPlacer(13, 2, 14), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(3, 7)), new TwoLayersFeatureSize(1, 1, 2)).decorators((List<TreeDecorator>)ImmutableList.of((Object)new AlterGroundDecorator(BlockStateProvider.simple(Blocks.PODZOL)))).build());
        FeatureUtils.register(bootstrapContext, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createSuperBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)beehiveDecorator)).build());
        FeatureUtils.register(bootstrapContext, SUPER_BIRCH_BEES, Feature.TREE, TreeFeatures.createSuperBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)beehiveDecorator5)).build());
        FeatureUtils.register(bootstrapContext, SWAMP_OAK, Feature.TREE, TreeFeatures.createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators((List<TreeDecorator>)ImmutableList.of((Object)new LeaveVineDecorator(0.25f))).build());
        FeatureUtils.register(bootstrapContext, JUNGLE_BUSH, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.JUNGLE_LOG), new StraightTrunkPlacer(1, 0, 0), BlockStateProvider.simple(Blocks.OAK_LEAVES), new BushFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2), new TwoLayersFeatureSize(0, 0, 0)).build());
        FeatureUtils.register(bootstrapContext, AZALEA_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.OAK_LOG), new BendingTrunkPlacer(4, 2, 0, 3, UniformInt.of(1, 2)), new WeightedStateProvider(WeightedList.builder().add(Blocks.AZALEA_LEAVES.defaultBlockState(), 3).add(Blocks.FLOWERING_AZALEA_LEAVES.defaultBlockState(), 1)), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 50), new TwoLayersFeatureSize(1, 0, 1)).dirt(BlockStateProvider.simple(Blocks.ROOTED_DIRT)).forceDirt().build());
        FeatureUtils.register(bootstrapContext, MANGROVE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformInt.of(1, 4), 0.5f, UniformInt.of(0, 1), holderGetter.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(1, 3), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.5f)), new MangroveRootPlacement(holderGetter.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2f))), new TwoLayersFeatureSize(2, 0, 2)).decorators(List.of((Object)new LeaveVineDecorator(0.125f), (Object)new AttachedToLeavesDecorator(0.14f, 1, 0, new RandomizedIntStateProvider((BlockStateProvider)BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, (IntProvider)UniformInt.of(0, 4)), 2, List.of((Object)Direction.DOWN)), (Object)beehiveDecorator2)).ignoreVines().build());
        FeatureUtils.register(bootstrapContext, TALL_MANGROVE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformInt.of(1, 6), 0.5f, UniformInt.of(0, 1), holderGetter.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(3, 7), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.5f)), new MangroveRootPlacement(holderGetter.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2f))), new TwoLayersFeatureSize(3, 0, 2)).decorators(List.of((Object)new LeaveVineDecorator(0.125f), (Object)new AttachedToLeavesDecorator(0.14f, 1, 0, new RandomizedIntStateProvider((BlockStateProvider)BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, (IntProvider)UniformInt.of(0, 4)), 2, List.of((Object)Direction.DOWN)), (Object)beehiveDecorator2)).ignoreVines().build());
        FeatureUtils.register(bootstrapContext, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators(List.of((Object)beehiveDecorator, (Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, OAK_BEES_002, Feature.TREE, TreeFeatures.createOak().decorators(List.of((Object)beehiveDecorator3)).build());
        FeatureUtils.register(bootstrapContext, OAK_BEES_005, Feature.TREE, TreeFeatures.createOak().decorators(List.of((Object)beehiveDecorator4)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of((Object)beehiveDecorator)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators(List.of((Object)beehiveDecorator, (Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of((Object)beehiveDecorator3)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_005, Feature.TREE, TreeFeatures.createBirch().decorators(List.of((Object)beehiveDecorator4)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of((Object)beehiveDecorator, (Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_002, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of((Object)beehiveDecorator3)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_005, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of((Object)beehiveDecorator4)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of((Object)beehiveDecorator5)).build());
        FeatureUtils.register(bootstrapContext, OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators((List<TreeDecorator>)ImmutableList.of((Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, DARK_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createDarkOak().ignoreVines().decorators((List<TreeDecorator>)ImmutableList.of((Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of((Object)placeOnGroundDecorator, (Object)placeOnGroundDecorator2)).build());
        FeatureUtils.register(bootstrapContext, FALLEN_OAK_TREE, Feature.FALLEN_TREE, TreeFeatures.createFallenOak().build());
        FeatureUtils.register(bootstrapContext, FALLEN_BIRCH_TREE, Feature.FALLEN_TREE, TreeFeatures.createFallenBirch(8).build());
        FeatureUtils.register(bootstrapContext, FALLEN_SUPER_BIRCH_TREE, Feature.FALLEN_TREE, TreeFeatures.createFallenBirch(15).build());
        FeatureUtils.register(bootstrapContext, FALLEN_JUNGLE_TREE, Feature.FALLEN_TREE, TreeFeatures.createFallenJungle().build());
        FeatureUtils.register(bootstrapContext, FALLEN_SPRUCE_TREE, Feature.FALLEN_TREE, TreeFeatures.createFallenSpruce().build());
    }
}
