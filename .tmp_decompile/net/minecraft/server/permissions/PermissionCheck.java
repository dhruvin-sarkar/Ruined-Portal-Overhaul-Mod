...
public interface PermissionCheck {
    public static final Codec<PermissionCheck> CODEC = BuiltInRegistries.PERMISSION_CHECK_TYPE.byNameCodec().dispatch(PermissionCheck::codec, mapCodec -> mapCodec);
    ...
    {
        public static final MapCodec<Require> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Permission.CODEC.fieldOf("permission").forGetter(Require::permission)).apply((Applicative)instance, Require::new));
