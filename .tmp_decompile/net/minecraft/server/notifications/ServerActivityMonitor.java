...
public class ServerActivityMonitor {
    ...
    public ServerActivityMonitor(NotificationManager notificationManager, int i) {
        this.notificationManager = notificationManager;
        this.minimumMillisBetweenNotifications = TimeUnit.SECONDS.toMillis(i);
    }
    ...
    private void processWithRateLimit() {
        ...
        if (this.serverActivity.get() && l - this.lastNotificationTime.get() >= this.minimumMillisBetweenNotifications) {
