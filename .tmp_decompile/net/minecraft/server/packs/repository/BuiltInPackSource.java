...
implements RepositorySource {
    ...
    public BuiltInPackSource(PackType packType, VanillaPackResources vanillaPackResources, Identifier identifier, DirectoryValidator directoryValidator) {
        this.packType = packType;
        this.vanillaPack = vanillaPackResources;
        this.packDir = identifier;
    ...
    protected void discoverPacksInPath(@Nullable Path path2, BiConsumer<String, Function<String, @Nullable Pack>> biConsumer) {
