...
implements DataProvider {
    ...
    public CompletableFuture<?> run(CachedOutput cachedOutput) {
        ...
        return DataProvider.saveStable(cachedOutput, (JsonElement)DiscoveryService.DiscoverResponse.CODEC.codec().encodeStart((DynamicOps)JsonOps.INSTANCE, (Object)discoverResponse).getOrThrow(), this.path);
    }
