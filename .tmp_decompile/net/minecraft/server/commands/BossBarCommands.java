...
public class BossBarCommands {
    ...
    private static int createBar(CommandSourceStack commandSourceStack, Identifier identifier, Component component) throws CommandSyntaxException {
        CustomBossEvents customBossEvents = commandSourceStack.getServer().getCustomBossEvents();
        if (customBossEvents.get(identifier) != null) {
            throw ERROR_ALREADY_EXISTS.create((Object)identifier.toString());
        }
        CustomBossEvent customBossEvent = customBossEvents.create(identifier, ComponentUtils.updateForEntity(commandSourceStack, component, null, 0));
    ...
    public static CustomBossEvent getBossBar(CommandContext<CommandSourceStack> commandContext) throws CommandSyntaxException {
        ...
        CustomBossEvent customBossEvent = ((CommandSourceStack)commandContext.getSource()).getServer().getCustomBossEvents().get(identifier);
        if (customBossEvent == null) {
            throw ERROR_DOESNT_EXIST.create((Object)identifier.toString());
        }
