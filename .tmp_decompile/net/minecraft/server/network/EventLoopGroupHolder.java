...
public abstract class EventLoopGroupHolder {
    ...
    public static EventLoopGroupHolder remote(boolean bl) {
        if (bl) {
    ...
    EventLoopGroupHolder(String string, Class<? extends Channel> class_, Class<? extends ServerChannel> class2) {
        this.type = string;
        this.channelCls = class_;
        this.serverChannelCls = class2;
    }
    ...
    public EventLoopGroup eventLoopGroup() {
        ...
        if (eventLoopGroup == null) {
            ...
            synchronized (eventLoopGroupHolder) {
                ...
                if (eventLoopGroup == null) {
                    this.group = eventLoopGroup = this.createEventLoopGroup();
                }
            }
        }
