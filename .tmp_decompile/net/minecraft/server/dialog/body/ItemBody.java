...
{
    public static final MapCodec<ItemBody> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ItemStack.STRICT_CODEC.fieldOf("item").forGetter(ItemBody::item), (App)PlainMessage.CODEC.optionalFieldOf("description").forGetter(ItemBody::description), (App)Codec.BOOL.optionalFieldOf("show_decorations", (Object)true).forGetter(ItemBody::showDecorations), (App)Codec.BOOL.optionalFieldOf("show_tooltip", (Object)true).forGetter(ItemBody::showTooltip), (App)ExtraCodecs.intRange(1, 256).optionalFieldOf("width", (Object)16).forGetter(ItemBody::width), (App)ExtraCodecs.intRange(1, 256).optionalFieldOf("height", (Object)16).forGetter(ItemBody::height)).apply((Applicative)instance, ItemBody::new));
