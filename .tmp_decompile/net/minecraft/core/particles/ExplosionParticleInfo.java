...
public record ExplosionParticleInfo(ParticleOptions particle, float scaling, float speed) {
    public static final MapCodec<ExplosionParticleInfo> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ParticleTypes.CODEC.fieldOf("particle").forGetter(ExplosionParticleInfo::particle), (App)Codec.FLOAT.optionalFieldOf("scaling", (Object)Float.valueOf(1.0f)).forGetter(ExplosionParticleInfo::scaling), (App)Codec.FLOAT.optionalFieldOf("speed", (Object)Float.valueOf(1.0f)).forGetter(ExplosionParticleInfo::speed)).apply((Applicative)instance, ExplosionParticleInfo::new));
