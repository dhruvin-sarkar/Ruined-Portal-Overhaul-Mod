...
{
    public static final MapCodec<SculkChargeParticleOptions> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.fieldOf("roll").forGetter(sculkChargeParticleOptions -> Float.valueOf(sculkChargeParticleOptions.roll))).apply((Applicative)instance, SculkChargeParticleOptions::new));
