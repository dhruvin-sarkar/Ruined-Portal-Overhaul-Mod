...
public final class DataComponentPatch {
    ...
    public static final Codec<DataComponentPatch> CODEC = Codec.dispatchedMap(PatchKey.CODEC, PatchKey::valueCodec).xmap(map -> {
        ...
        for (Map.Entry entry : map.entrySet()) {
            PatchKey patchKey = (PatchKey)((Object)((Object)entry.getKey()));
            if (patchKey.removed()) {
    ...
    public static class Builder {
        ...
        public <T> Builder set(DataComponentType<T> dataComponentType, T object) {
    ...
    record PatchKey(DataComponentType<?> type, boolean removed) {
        public static final Codec<PatchKey> CODEC = Codec.STRING.flatXmap(string -> {
            ...
            if ((dataComponentType = BuiltInRegistries.DATA_COMPONENT_TYPE.getValue(identifier = Identifier.tryParse(string))) == null) {
            ...
            return DataResult.success((Object)((Object)new PatchKey(dataComponentType, bl)));
        }, patchKey -> {
            ...
            return DataResult.success((Object)(patchKey.removed() ? DataComponentPatch.REMOVED_PREFIX + String.valueOf(identifier) : identifier.toString()));
        });
