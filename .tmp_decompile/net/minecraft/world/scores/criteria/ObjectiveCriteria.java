...
public class ObjectiveCriteria {
    ...
    public static Optional<ObjectiveCriteria> byName(String string) {
        ...
        return BuiltInRegistries.STAT_TYPE.getOptional(Identifier.bySeparator(string.substring(0, i), '.')).flatMap(statType -> ObjectiveCriteria.getStat(statType, Identifier.bySeparator(string.substring(i + 1), '.')));
    }

    private static <T> Optional<ObjectiveCriteria> getStat(StatType<T> statType, Identifier identifier) {
