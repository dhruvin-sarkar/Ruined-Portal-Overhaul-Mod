...
public interface TradeRebalanceEnchantmentProviders {
    ...
    public static void bootstrap(BootstrapContext<EnchantmentProvider> bootstrapContext) {
        ...
        bootstrapContext.register(TRADES_JUNGLE_ARMORER_HELMET_5, new SingleEnchantment(holderGetter.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantInt.of(1)));
