...
public record RunFunction(Identifier function) implements EnchantmentEntityEffect
{
    ...
    public static final MapCodec<RunFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("function").forGetter(RunFunction::function)).apply((Applicative)instance, RunFunction::new));
