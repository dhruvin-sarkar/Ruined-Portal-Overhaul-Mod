...
extends TransformedSlotSource {
    public static final MapCodec<ContentsSlotSource> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> ContentsSlotSource.commonFields(instance).and((App)ContainerComponentManipulators.CODEC.fieldOf("component").forGetter(contentsSlotSource -> contentsSlotSource.component)).apply((Applicative)instance, ContentsSlotSource::new));
