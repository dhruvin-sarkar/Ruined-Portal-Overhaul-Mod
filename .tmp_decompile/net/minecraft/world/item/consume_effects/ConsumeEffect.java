...
public interface ConsumeEffect {
    ...
    public record Type<T extends ConsumeEffect>(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
        ...
        private static <T extends ConsumeEffect> Type<T> register(String string, MapCodec<T> mapCodec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
            return Registry.register(BuiltInRegistries.CONSUME_EFFECT_TYPE, string, new Type<T>(mapCodec, streamCodec));
        }
    }
}
