...
public class Items {
    ...
    public static final Item ACACIA_SHELF = Items.registerBlock(Blocks.ACACIA_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BAMBOO_SHELF = Items.registerBlock(Blocks.BAMBOO_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BIRCH_SHELF = Items.registerBlock(Blocks.BIRCH_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CHERRY_SHELF = Items.registerBlock(Blocks.CHERRY_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CRIMSON_SHELF = Items.registerBlock(Blocks.CRIMSON_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DARK_OAK_SHELF = Items.registerBlock(Blocks.DARK_OAK_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item JUNGLE_SHELF = Items.registerBlock(Blocks.JUNGLE_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item MANGROVE_SHELF = Items.registerBlock(Blocks.MANGROVE_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item OAK_SHELF = Items.registerBlock(Blocks.OAK_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item PALE_OAK_SHELF = Items.registerBlock(Blocks.PALE_OAK_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SPRUCE_SHELF = Items.registerBlock(Blocks.SPRUCE_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item WARPED_SHELF = Items.registerBlock(Blocks.WARPED_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item CARVED_PUMPKIN = Items.registerBlock(Blocks.CARVED_PUMPKIN, properties -> Waypoint.addHideAttribute(properties).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).setCameraOverlay(Identifier.withDefaultNamespace("misc/pumpkinblur")).build()));
    ...
    public static final Item COPPER_TORCH = Items.registerBlock(Blocks.COPPER_TORCH, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.COPPER_WALL_TORCH, Direction.DOWN, (Item.Properties)properties));
    ...
    public static final Item COPPER_SHOVEL = Items.registerItem("copper_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.COPPER, 1.5f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item COPPER_AXE = Items.registerItem("copper_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.COPPER, 7.0f, -3.2f, (Item.Properties)properties));
    public static final Item COPPER_HOE = Items.registerItem("copper_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.COPPER, -1.0f, -2.0f, (Item.Properties)properties));
    ...
    public static final Item PUFFERFISH_BUCKET = Items.registerItem("pufferfish_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.PUFFERFISH));
    public static final Item SALMON_BUCKET = Items.registerItem("salmon_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.SALMON));
    public static final Item COD_BUCKET = Items.registerItem("cod_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.COD));
    public static final Item TROPICAL_FISH_BUCKET = Items.registerItem("tropical_fish_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.TROPICAL_FISH));
    ...
    private static Item registerSpawnEgg(EntityType<?> entityType) {
        return Items.registerItem(ResourceKey.create(Registries.ITEM, EntityType.getKey(entityType).withSuffix("_spawn_egg")), SpawnEggItem::new, new Item.Properties().spawnEgg(entityType));
    }
