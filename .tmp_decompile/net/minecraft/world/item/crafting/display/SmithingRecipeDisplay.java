...
{
    public static final MapCodec<SmithingRecipeDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)SlotDisplay.CODEC.fieldOf("template").forGetter(SmithingRecipeDisplay::template), (App)SlotDisplay.CODEC.fieldOf("base").forGetter(SmithingRecipeDisplay::base), (App)SlotDisplay.CODEC.fieldOf("addition").forGetter(SmithingRecipeDisplay::addition), (App)SlotDisplay.CODEC.fieldOf("result").forGetter(SmithingRecipeDisplay::result), (App)SlotDisplay.CODEC.fieldOf("crafting_station").forGetter(SmithingRecipeDisplay::craftingStation)).apply((Applicative)instance, SmithingRecipeDisplay::new));
