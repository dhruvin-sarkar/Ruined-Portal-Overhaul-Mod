...
public record DeathProtection(List<ConsumeEffect> deathEffects) {
    public static final Codec<DeathProtection> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ConsumeEffect.CODEC.listOf().optionalFieldOf("death_effects", (Object)List.of()).forGetter(DeathProtection::deathEffects)).apply((Applicative)instance, DeathProtection::new));
