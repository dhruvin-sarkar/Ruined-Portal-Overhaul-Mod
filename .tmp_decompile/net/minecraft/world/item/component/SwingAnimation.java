...
public record SwingAnimation(SwingAnimationType type, int duration) {
    ...
    public static final Codec<SwingAnimation> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)SwingAnimationType.CODEC.optionalFieldOf("type", (Object)SwingAnimation.DEFAULT.type).forGetter(SwingAnimation::type), (App)ExtraCodecs.POSITIVE_INT.optionalFieldOf("duration", (Object)SwingAnimation.DEFAULT.duration).forGetter(SwingAnimation::duration)).apply((Applicative)instance, SwingAnimation::new));
