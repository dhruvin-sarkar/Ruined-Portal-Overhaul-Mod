...
public record CustomModelData(List<Float> floats, List<Boolean> flags, List<String> strings, List<Integer> colors) {
    ...
    public static final Codec<CustomModelData> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.FLOAT.listOf().optionalFieldOf("floats", (Object)List.of()).forGetter(CustomModelData::floats), (App)Codec.BOOL.listOf().optionalFieldOf("flags", (Object)List.of()).forGetter(CustomModelData::flags), (App)Codec.STRING.listOf().optionalFieldOf("strings", (Object)List.of()).forGetter(CustomModelData::strings), (App)ExtraCodecs.RGB_COLOR_CODEC.listOf().optionalFieldOf("colors", (Object)List.of()).forGetter(CustomModelData::colors)).apply((Applicative)instance, CustomModelData::new));
    ...
    public @Nullable Float getFloat(int i) {
        return CustomModelData.getSafe(this.floats, i);
    }

    public @Nullable Boolean getBoolean(int i) {
        return CustomModelData.getSafe(this.flags, i);
    }

    public @Nullable String getString(int i) {
        return CustomModelData.getSafe(this.strings, i);
    }

    public @Nullable Integer getColor(int i) {
        return CustomModelData.getSafe(this.colors, i);
    }
}
