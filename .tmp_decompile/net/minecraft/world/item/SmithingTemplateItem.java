...
extends Item {
    ...
    public SmithingTemplateItem(Component component, Component component2, Component component3, Component component4, List<Identifier> list, List<Identifier> list2, Item.Properties properties) {
        super(properties);
    ...
    private static List<Identifier> createNetheriteUpgradeIconList() {
        return List.of((Object[])new Identifier[]{EMPTY_SLOT_HELMET, EMPTY_SLOT_SWORD, EMPTY_SLOT_CHESTPLATE, EMPTY_SLOT_PICKAXE, EMPTY_SLOT_LEGGINGS, EMPTY_SLOT_AXE, EMPTY_SLOT_BOOTS, EMPTY_SLOT_HOE, EMPTY_SLOT_SHOVEL, EMPTY_SLOT_NAUTILUS_ARMOR, EMPTY_SLOT_SPEAR});
    }
