...
public class CreativeModeTabs {
    ...
    private static ResourceKey<CreativeModeTab> createKey(String string) {
        return ResourceKey.create(Registries.CREATIVE_MODE_TAB, Identifier.withDefaultNamespace(string));
    }
    ...
    public static CreativeModeTab bootstrap(Registry<CreativeModeTab> registry) {
        Registry.register(registry, BUILDING_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0).title(Component.translatable("itemGroup.buildingBlocks")).icon(() -> new ItemStack(Blocks.BRICKS)).displayItems((itemDisplayParameters, output) -> {
            ...
            output.accept(Items.COPPER_BARS.exposed());
            ...
            output.accept(Items.COPPER_CHAIN.exposed());
            ...
            output.accept(Items.COPPER_BARS.weathered());
            ...
            output.accept(Items.COPPER_CHAIN.weathered());
            ...
            output.accept(Items.COPPER_BARS.oxidized());
            ...
            output.accept(Items.COPPER_CHAIN.oxidized());
            ...
            output.accept(Items.COPPER_BARS.waxedExposed());
            ...
            output.accept(Items.COPPER_CHAIN.waxedExposed());
            ...
            output.accept(Items.COPPER_BARS.waxedWeathered());
            ...
            output.accept(Items.COPPER_CHAIN.waxedWeathered());
            ...
            output.accept(Items.COPPER_BARS.waxedOxidized());
            ...
            output.accept(Items.COPPER_CHAIN.waxedOxidized());
        }).build());
        ...
        Registry.register(registry, FUNCTIONAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 3).title(Component.translatable("itemGroup.functional")).icon(() -> new ItemStack(Items.OAK_SIGN)).displayItems((itemDisplayParameters, output) -> {
            ...
            output.accept(Items.COPPER_TORCH);
            output.accept(Items.REDSTONE_TORCH);
            output.accept(Items.LANTERN);
            output.accept(Items.SOUL_LANTERN);
            Items.COPPER_LANTERN.forEach(output::accept);
            output.accept(Items.IRON_CHAIN);
            Items.COPPER_CHAIN.forEach(output::accept);
            ...
            output.accept(Items.EXPOSED_LIGHTNING_ROD);
            output.accept(Items.WEATHERED_LIGHTNING_ROD);
            output.accept(Items.OXIDIZED_LIGHTNING_ROD);
            output.accept(Items.WAXED_LIGHTNING_ROD);
            output.accept(Items.WAXED_EXPOSED_LIGHTNING_ROD);
            output.accept(Items.WAXED_WEATHERED_LIGHTNING_ROD);
            output.accept(Items.WAXED_OXIDIZED_LIGHTNING_ROD);
            ...
            output.accept(Items.OAK_SHELF);
            output.accept(Items.SPRUCE_SHELF);
            output.accept(Items.BIRCH_SHELF);
            output.accept(Items.JUNGLE_SHELF);
            output.accept(Items.ACACIA_SHELF);
            output.accept(Items.DARK_OAK_SHELF);
            output.accept(Items.MANGROVE_SHELF);
            output.accept(Items.CHERRY_SHELF);
            output.accept(Items.PALE_OAK_SHELF);
            output.accept(Items.BAMBOO_SHELF);
            output.accept(Items.CRIMSON_SHELF);
            output.accept(Items.WARPED_SHELF);
            ...
            output.accept(Items.WEATHERED_COPPER_CHEST);
            output.accept(Items.OXIDIZED_COPPER_CHEST);
            output.accept(Items.WAXED_COPPER_CHEST);
            output.accept(Items.WAXED_EXPOSED_COPPER_CHEST);
            output.accept(Items.WAXED_WEATHERED_COPPER_CHEST);
            output.accept(Items.WAXED_OXIDIZED_COPPER_CHEST);
            ...
            output.accept(Items.COPPER_GOLEM_STATUE);
            output.accept(Items.EXPOSED_COPPER_GOLEM_STATUE);
            output.accept(Items.WEATHERED_COPPER_GOLEM_STATUE);
            output.accept(Items.OXIDIZED_COPPER_GOLEM_STATUE);
            output.accept(Items.WAXED_COPPER_GOLEM_STATUE);
            output.accept(Items.WAXED_EXPOSED_COPPER_GOLEM_STATUE);
            output.accept(Items.WAXED_WEATHERED_COPPER_GOLEM_STATUE);
            output.accept(Items.WAXED_OXIDIZED_COPPER_GOLEM_STATUE);
        ...
        Registry.register(registry, SPAWN_EGGS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4).title(Component.translatable("itemGroup.spawnEggs")).icon(() -> new ItemStack(Items.CREEPER_SPAWN_EGG)).displayItems((itemDisplayParameters, output) -> {
            ...
            output.accept(Items.CAMEL_HUSK_SPAWN_EGG);
            output.accept(Items.DROWNED_SPAWN_EGG);
            output.accept(Items.HUSK_SPAWN_EGG);
            output.accept(Items.PARCHED_SPAWN_EGG);
    ...
    public static void validate() {
        ...
        for (ResourceKey<CreativeModeTab> resourceKey : BuiltInRegistries.CREATIVE_MODE_TAB.registryKeySet()) {
            ...
            String string2 = map.put(Pair.of((Object)((Object)creativeModeTab.row()), (Object)creativeModeTab.column()), string);
    ...
    private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, CreativeModeTab.TabVisibility tabVisibility) {
        holderLookup.listElements().map(reference -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder<Enchantment>)reference, ((Enchantment)((Object)((Object)reference.value()))).getMaxLevel()))).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
    ...
    private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, CreativeModeTab.TabVisibility tabVisibility) {
        holderLookup.listElements().flatMap(reference -> IntStream.rangeClosed(((Enchantment)((Object)((Object)reference.value()))).getMinLevel(), ((Enchantment)((Object)((Object)reference.value()))).getMaxLevel()).mapToObj(i -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder<Enchantment>)reference, i)))).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
