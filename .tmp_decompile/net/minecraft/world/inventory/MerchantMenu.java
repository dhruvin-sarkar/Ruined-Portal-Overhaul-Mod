...
extends AbstractContainerMenu {
    ...
    public void tryMoveItems(int i) {
        ...
        if (this.tradeContainer.getItem(0).isEmpty() && this.tradeContainer.getItem(1).isEmpty()) {
            ...
            merchantOffer.getItemCostB().ifPresent(itemCost -> this.moveFromInventoryToPaymentSlot(1, (ItemCost)((Object)itemCost)));
        }
    }
    ...
    private void moveFromInventoryToPaymentSlot(int i, ItemCost itemCost) {
        for (int j = 3; j < 39; ++j) {
            ...
            if (itemStack.isEmpty() || !itemCost.test(itemStack) || !(itemStack2 = this.tradeContainer.getItem(i)).isEmpty() && !ItemStack.isSameItemSameComponents(itemStack, itemStack2)) continue;
            ...
            if (itemStack3.getCount() >= k) break;
        }
    }
