...
extends RecipeBookMenu {
    ...
    protected AbstractFurnaceMenu(MenuType<?> menuType, RecipeType<? extends AbstractCookingRecipe> recipeType, ResourceKey<RecipePropertySet> resourceKey, RecipeBookType recipeBookType, int i, Inventory inventory) {
        this(menuType, recipeType, resourceKey, recipeBookType, i, inventory, new SimpleContainer(3), new SimpleContainerData(4));
    }

    protected AbstractFurnaceMenu(MenuType<?> menuType, RecipeType<? extends AbstractCookingRecipe> recipeType, ResourceKey<RecipePropertySet> resourceKey, RecipeBookType recipeBookType, int i, Inventory inventory, Container container, ContainerData containerData) {
        super(menuType, i);
    ...
    public RecipeBookMenu.PostPlaceAction handlePlacement(boolean bl, boolean bl2, RecipeHolder<?> recipeHolder, final ServerLevel serverLevel, Inventory inventory) {
        final List list = List.of((Object)this.getSlot(0), (Object)this.getSlot(2));
        ...
        }, 1, 1, List.of((Object)this.getSlot(0)), list, inventory, recipeHolder2, bl, bl2);
    }
}
