...
extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player player, int i) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (i == 1 || i == 0 ? !this.moveItemStackTo(itemStack2, 3, 39, false) : (itemStack2.has(DataComponents.MAP_ID) ? !this.moveItemStackTo(itemStack2, 0, 1, false) : (itemStack2.is(Items.PAPER) || itemStack2.is(Items.MAP) || itemStack2.is(Items.GLASS_PANE) ? !this.moveItemStackTo(itemStack2, 1, 2, false) : (i >= 3 && i < 30 ? !this.moveItemStackTo(itemStack2, 30, 39, false) : i >= 30 && i < 39 && !this.moveItemStackTo(itemStack2, 3, 30, false))))) {
                return ItemStack.EMPTY;
            }
