...
extends AbstractContainerMenu {
    ...
    public void slotsChanged(Container container) {
        ...
        if (holder != null) {
            ...
            boolean bl3 = bl2 = bannerPatternLayers.layers().size() >= 6;
            if (bl2) {
                this.selectedBannerPatternIndex.set(-1);
                this.resultSlot.set(ItemStack.EMPTY);
            } else {
    ...
    public ItemStack quickMoveStack(Player player, int i) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (i == this.dyeSlot.index || i == this.bannerSlot.index || i == this.patternSlot.index ? !this.moveItemStackTo(itemStack2, 4, 40, false) : (itemStack2.getItem() instanceof BannerItem ? !this.moveItemStackTo(itemStack2, this.bannerSlot.index, this.bannerSlot.index + 1, false) : (itemStack2.getItem() instanceof DyeItem ? !this.moveItemStackTo(itemStack2, this.dyeSlot.index, this.dyeSlot.index + 1, false) : (itemStack2.has(DataComponents.PROVIDES_BANNER_PATTERNS) ? !this.moveItemStackTo(itemStack2, this.patternSlot.index, this.patternSlot.index + 1, false) : (i >= 4 && i < 31 ? !this.moveItemStackTo(itemStack2, 31, 40, false) : i >= 31 && i < 40 && !this.moveItemStackTo(itemStack2, 4, 31, false)))))) {
                return ItemStack.EMPTY;
            }
