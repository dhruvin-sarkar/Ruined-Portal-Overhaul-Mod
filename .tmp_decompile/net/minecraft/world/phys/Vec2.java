...
public class Vec2 {
    ...
    public static final Codec<Vec2> CODEC = Codec.FLOAT.listOf().comapFlatMap(list2 -> Util.fixedSize(list2, 2).map(list -> new Vec2(((Float)list.get(0)).floatValue(), ((Float)list.get(1)).floatValue())), vec2 -> List.of((Object)Float.valueOf(vec2.x), (Object)Float.valueOf(vec2.y)));
