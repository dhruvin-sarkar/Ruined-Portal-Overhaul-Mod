...
public interface AttributeTypes {
    ...
    public static <Value> AttributeType<Value> register(String string, AttributeType<Value> attributeType) {
        Registry.register(BuiltInRegistries.ATTRIBUTE_TYPE, Identifier.withDefaultNamespace(string), attributeType);
