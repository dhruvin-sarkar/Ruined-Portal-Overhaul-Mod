...
public interface EnvironmentAttributes {
    ...
    public static final EnvironmentAttribute<Float> TURTLE_EGG_HATCH_CHANCE = EnvironmentAttributes.register("gameplay/turtle_egg_hatch_chance", EnvironmentAttribute.builder(AttributeTypes.FLOAT).defaultValue(Float.valueOf(0.0f)).valueRange(AttributeRange.UNIT_FLOAT));
    ...
    private static <Value> EnvironmentAttribute<Value> register(String string, EnvironmentAttribute.Builder<Value> builder) {
        ...
        Registry.register(BuiltInRegistries.ENVIRONMENT_ATTRIBUTE, Identifier.withDefaultNamespace(string), environmentAttribute);
