...
public class MapDecorationTypes {
    ...
    private static Holder<MapDecorationType> register(String string, String string2, boolean bl, int i, boolean bl2, boolean bl3) {
        ResourceKey<MapDecorationType> resourceKey = ResourceKey.create(Registries.MAP_DECORATION_TYPE, Identifier.withDefaultNamespace(string));
        MapDecorationType mapDecorationType = new MapDecorationType(Identifier.withDefaultNamespace(string2), bl, i, bl3, bl2);
