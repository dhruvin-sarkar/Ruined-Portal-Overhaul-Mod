...
implements AutoCloseable {
    ...
    public PersistentEntitySectionManager(Class<T> class_, LevelCallback<T> levelCallback, EntityPersistentStorage<T> entityPersistentStorage) {
        ...
        this.sectionStorage = new EntitySectionStorage<T>(class_, (Long2ObjectFunction<Visibility>)this.chunkVisibility);
    ...
    implements EntityInLevelCallback {
        ...
        Callback(T t, long entitySection, EntitySection<T> entitySection2) {
            void var3_3;
            void entityAccess;
            this.field_27271 = (PersistentEntitySectionManager)persistentEntitySectionManager;
