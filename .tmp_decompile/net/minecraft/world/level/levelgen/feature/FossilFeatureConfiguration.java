...
implements FeatureConfiguration {
    ...
    public FossilFeatureConfiguration(List<Identifier> list, List<Identifier> list2, Holder<StructureProcessorList> holder, Holder<StructureProcessorList> holder2, int i) {
        if (list.isEmpty()) {
