            ...
            for (t = 0; t < 16; ++t) {
                for (int u = 0; u < 16; ++u) {
                    for (int v = 0; v < 8; ++v) {
                        ...
                        if (!bl2 || v >= 4 && randomSource.nextInt(2) == 0 || !(blockState4 = worldGenLevel.getBlockState(blockPos.offset(t, v, u))).isSolid() || blockState4.is(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE)) continue;
