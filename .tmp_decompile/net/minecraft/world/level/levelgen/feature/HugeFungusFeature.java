...
extends Feature<HugeFungusConfiguration> {
    ...
    private void placeStem(WorldGenLevel worldGenLevel, RandomSource randomSource, HugeFungusConfiguration hugeFungusConfiguration, BlockPos blockPos, int i, boolean bl) {
    ...
    private void placeHat(WorldGenLevel worldGenLevel, RandomSource randomSource, HugeFungusConfiguration hugeFungusConfiguration, BlockPos blockPos, int i, boolean bl) {
        int k;
        BlockPos.MutableBlockPos mutableBlockPos = new BlockPos.MutableBlockPos();
