...
extends Feature<SpikeConfiguration> {
    ...
    private void placeSpike(ServerLevelAccessor serverLevelAccessor, RandomSource randomSource, SpikeConfiguration spikeConfiguration, EndSpike endSpike) {
        ...
        for (BlockPos blockPos : BlockPos.betweenClosed(new BlockPos(endSpike.getCenterX() - i, serverLevelAccessor.getMinY(), endSpike.getCenterZ() - i), new BlockPos(endSpike.getCenterX() + i, endSpike.getHeight() + 10, endSpike.getCenterZ() + i))) {
        ...
        if ((endCrystal = EntityType.END_CRYSTAL.create(serverLevelAccessor.getLevel(), EntitySpawnReason.STRUCTURE)) != null) {
            ...
            endCrystal.snapTo((double)endSpike.getCenterX() + 0.5, endSpike.getHeight() + 1, (double)endSpike.getCenterZ() + 0.5, randomSource.nextFloat() * 360.0f, 0.0f);
            serverLevelAccessor.addFreshEntity(endCrystal);
            BlockPos blockPos = endCrystal.blockPosition();
