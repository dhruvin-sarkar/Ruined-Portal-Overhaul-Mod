...
public class PerlinNoise {
    ...
    public static PerlinNoise createLegacyForLegacyNetherBiome(RandomSource randomSource, int i, DoubleList doubleList) {
        return new PerlinNoise(randomSource, (Pair<Integer, DoubleList>)Pair.of((Object)i, (Object)doubleList), false);
    }
    ...
    public static PerlinNoise create(RandomSource randomSource, int i, double d, double ... ds) {
        ...
        return new PerlinNoise(randomSource, (Pair<Integer, DoubleList>)Pair.of((Object)i, (Object)doubleArrayList), true);
    }

    public static PerlinNoise create(RandomSource randomSource, int i, DoubleList doubleList) {
        return new PerlinNoise(randomSource, (Pair<Integer, DoubleList>)Pair.of((Object)i, (Object)doubleList), true);
    }
    ...
    public void parityConfigString(StringBuilder stringBuilder) {
        ...
        List list = this.amplitudes.stream().map(double_ -> String.format(Locale.ROOT, "%.2f", double_)).toList();
