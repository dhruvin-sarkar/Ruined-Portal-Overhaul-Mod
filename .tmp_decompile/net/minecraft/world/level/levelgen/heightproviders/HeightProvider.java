...
public abstract class HeightProvider {
    ...
    public static final Codec<HeightProvider> CODEC = CONSTANT_OR_DISPATCH_CODEC.xmap(either -> (HeightProvider)either.map(ConstantHeight::of, heightProvider -> heightProvider), heightProvider -> heightProvider.getType() == HeightProviderType.CONSTANT ? Either.left((Object)((ConstantHeight)heightProvider).getValue()) : Either.right((Object)heightProvider));
