...
public class ShipwreckPieces {
    ...
    public static ShipwreckPiece addRandomPiece(StructureTemplateManager structureTemplateManager, BlockPos blockPos, Rotation rotation, StructurePieceAccessor structurePieceAccessor, RandomSource randomSource, boolean bl) {
        Identifier identifier = Util.getRandom(bl ? STRUCTURE_LOCATION_BEACHED : STRUCTURE_LOCATION_OCEAN, randomSource);
        ShipwreckPiece shipwreckPiece = new ShipwreckPiece(structureTemplateManager, identifier, blockPos, rotation, bl);
    ...
    extends TemplateStructurePiece {
        ...
        public ShipwreckPiece(StructureTemplateManager structureTemplateManager, Identifier identifier, BlockPos blockPos, Rotation rotation, boolean bl) {
            super(StructurePieceType.SHIPWRECK_PIECE, 0, structureTemplateManager, identifier, identifier.toString(), ShipwreckPiece.makeSettings(rotation), blockPos);
            this.isBeached = bl;
        }

        public ShipwreckPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.SHIPWRECK_PIECE, compoundTag, structureTemplateManager, identifier -> ShipwreckPiece.makeSettings((Rotation)compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
