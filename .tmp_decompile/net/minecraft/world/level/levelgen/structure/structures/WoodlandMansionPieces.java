...
public class WoodlandMansionPieces {
    ...
    static class MansionGrid {
        ...
        public @Nullable Direction get1x2RoomDirection(SimpleGrid simpleGrid, int i, int j, int k, int l) {
    ...
    extends TemplateStructurePiece {
        ...
        public WoodlandMansionPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.WOODLAND_MANSION_PIECE, compoundTag, structureTemplateManager, (Identifier identifier) -> WoodlandMansionPiece.makeSettings((Mirror)compoundTag.read("Mi", Mirror.LEGACY_CODEC).orElseThrow(), (Rotation)compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
        }
        ...
        protected void handleDataMarker(String string, BlockPos blockPos, ServerLevelAccessor serverLevelAccessor, RandomSource randomSource, BoundingBox boundingBox) {
            if (string.startsWith("Chest")) {
                ...
                ArrayList<@Nullable Mob> list = new ArrayList<Mob>();
                switch (string) {
                    case "Mage": {
