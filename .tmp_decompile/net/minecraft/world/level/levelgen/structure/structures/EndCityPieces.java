...
public class EndCityPieces {
    ...
    extends TemplateStructurePiece {
        public EndCityPiece(StructureTemplateManager structureTemplateManager, String string, BlockPos blockPos, Rotation rotation, boolean bl) {
            super(StructurePieceType.END_CITY_PIECE, 0, structureTemplateManager, EndCityPiece.makeIdentifier(string), string, EndCityPiece.makeSettings(bl, rotation), blockPos);
        }

        public EndCityPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.END_CITY_PIECE, compoundTag, structureTemplateManager, identifier -> EndCityPiece.makeSettings(compoundTag.getBooleanOr("OW", false), (Rotation)compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
        }
        ...
        private static Identifier makeIdentifier(String string) {
            return Identifier.withDefaultNamespace("end_city/" + string);
        }
