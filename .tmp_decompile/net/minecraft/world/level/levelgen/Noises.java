...
public class Noises {
    ...
    private static ResourceKey<NormalNoise.NoiseParameters> createKey(String string) {
        return ResourceKey.create(Registries.NOISE, Identifier.withDefaultNamespace(string));
    }
    ...
    public static NormalNoise instantiate(HolderGetter<NormalNoise.NoiseParameters> holderGetter, PositionalRandomFactory positionalRandomFactory, ResourceKey<NormalNoise.NoiseParameters> resourceKey) {
        ...
        return NormalNoise.create(positionalRandomFactory.fromHashOf(((ResourceKey)holder.unwrapKey().orElseThrow()).identifier()), (NormalNoise.NoiseParameters)((Object)holder.value()));
    }
}
