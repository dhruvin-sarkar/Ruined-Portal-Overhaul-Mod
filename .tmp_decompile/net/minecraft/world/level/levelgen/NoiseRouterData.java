...
public class NoiseRouterData {
    ...
    private static ResourceKey<DensityFunction> createKey(String string) {
        return ResourceKey.create(Registries.DENSITY_FUNCTION, Identifier.withDefaultNamespace(string));
    }
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> bootstrapContext) {
        ...
        bootstrapContext.register(Y, DensityFunctions.yClampedGradient(i, j, i, j));
        ...
        Holder.Reference<DensityFunction> holder = bootstrapContext.register(CONTINENTS, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.CONTINENTALNESS))));
        Holder.Reference<DensityFunction> holder2 = bootstrapContext.register(EROSION, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.EROSION))));
        ...
        NoiseRouterData.registerTerrainNoises(bootstrapContext, holderGetter2, densityFunction4, holder, holder2, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
        Holder.Reference<DensityFunction> holder3 = bootstrapContext.register(CONTINENTS_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.CONTINENTALNESS_LARGE))));
        Holder.Reference<DensityFunction> holder4 = bootstrapContext.register(EROSION_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.EROSION_LARGE))));
        NoiseRouterData.registerTerrainNoises(bootstrapContext, holderGetter2, densityFunction4, holder3, holder4, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false);
        NoiseRouterData.registerTerrainNoises(bootstrapContext, holderGetter2, densityFunction4, holder, holder2, OFFSET_AMPLIFIED, FACTOR_AMPLIFIED, JAGGEDNESS_AMPLIFIED, DEPTH_AMPLIFIED, SLOPED_CHEESE_AMPLIFIED, true);
    ...
    private static void registerTerrainNoises(BootstrapContext<DensityFunction> bootstrapContext, HolderGetter<DensityFunction> holderGetter, DensityFunction densityFunction, Holder<DensityFunction> holder, Holder<DensityFunction> holder2, ResourceKey<DensityFunction> resourceKey, ResourceKey<DensityFunction> resourceKey2, ResourceKey<DensityFunction> resourceKey3, ResourceKey<DensityFunction> resourceKey4, ResourceKey<DensityFunction> resourceKey5, boolean bl) {
        ...
        DensityFunction densityFunction4 = NoiseRouterData.registerAndWrap(bootstrapContext, resourceKey4, NoiseRouterData.offsetToDepth(densityFunction2));
    ...
    private static DensityFunction offsetToDepth(DensityFunction densityFunction) {
        return DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityFunction);
    }
    ...
    protected static NoiseRouter overworld(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, boolean bl, boolean bl2) {
        ...
        DensityFunction densityFunction9 = NoiseRouterData.getFunction(holderGetter, bl ? OFFSET_LARGE : (bl2 ? OFFSET_AMPLIFIED : OFFSET));
        DensityFunction densityFunction10 = NoiseRouterData.getFunction(holderGetter, bl ? FACTOR_LARGE : (bl2 ? FACTOR_AMPLIFIED : FACTOR));
        DensityFunction densityFunction11 = NoiseRouterData.getFunction(holderGetter, bl ? DEPTH_LARGE : (bl2 ? DEPTH_AMPLIFIED : DEPTH));
        DensityFunction densityFunction12 = NoiseRouterData.preliminarySurfaceLevel(densityFunction9, densityFunction10, bl2);
        DensityFunction densityFunction13 = NoiseRouterData.getFunction(holderGetter, bl ? SLOPED_CHEESE_LARGE : (bl2 ? SLOPED_CHEESE_AMPLIFIED : SLOPED_CHEESE));
        DensityFunction densityFunction14 = DensityFunctions.min(densityFunction13, DensityFunctions.mul(DensityFunctions.constant(5.0), NoiseRouterData.getFunction(holderGetter, ENTRANCES)));
        DensityFunction densityFunction15 = DensityFunctions.rangeChoice(densityFunction13, -1000000.0, 1.5625, densityFunction14, NoiseRouterData.underground(holderGetter, holderGetter2, densityFunction13));
        DensityFunction densityFunction16 = DensityFunctions.min(NoiseRouterData.postProcess(NoiseRouterData.slideOverworld(bl2, densityFunction15)), NoiseRouterData.getFunction(holderGetter, NOODLE));
        DensityFunction densityFunction17 = NoiseRouterData.getFunction(holderGetter, Y);
        ...
        DensityFunction densityFunction18 = NoiseRouterData.yLimitedInterpolatable(densityFunction17, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), i, j, 0);
        float f = 4.0f;
        DensityFunction densityFunction19 = NoiseRouterData.yLimitedInterpolatable(densityFunction17, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), i, j, 0).abs();
        DensityFunction densityFunction20 = NoiseRouterData.yLimitedInterpolatable(densityFunction17, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), i, j, 0).abs();
        DensityFunction densityFunction21 = DensityFunctions.add(DensityFunctions.constant(-0.08f), DensityFunctions.max(densityFunction19, densityFunction20));
        DensityFunction densityFunction22 = DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_GAP));
        return new NoiseRouter(densityFunction, densityFunction2, densityFunction3, densityFunction4, densityFunction7, densityFunction8, NoiseRouterData.getFunction(holderGetter, bl ? CONTINENTS_LARGE : CONTINENTS), NoiseRouterData.getFunction(holderGetter, bl ? EROSION_LARGE : EROSION), densityFunction11, NoiseRouterData.getFunction(holderGetter, RIDGES), densityFunction12, densityFunction16, densityFunction18, densityFunction21, densityFunction22);
    }
    ...
    protected static NoiseRouter end(HolderGetter<DensityFunction> holderGetter) {
        ...
        return new NoiseRouter(DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), densityFunction, DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), densityFunction2, DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero());
    }
    ...
    private static DensityFunction preliminarySurfaceLevel(DensityFunction densityFunction, DensityFunction densityFunction2, boolean bl) {
        DensityFunction densityFunction3 = DensityFunctions.cache2d(densityFunction2);
        DensityFunction densityFunction4 = DensityFunctions.cache2d(densityFunction);
        DensityFunction densityFunction5 = NoiseRouterData.remap(DensityFunctions.add(DensityFunctions.mul(DensityFunctions.constant(0.2734375), densityFunction3.invert()), DensityFunctions.mul(DensityFunctions.constant(-1.0), densityFunction4)), 1.5, -1.5, -64.0, 320.0);
        densityFunction5 = densityFunction5.clamp(-40.0, 320.0);
        DensityFunction densityFunction6 = DensityFunctions.add(NoiseRouterData.slideOverworld(bl, DensityFunctions.add(NoiseRouterData.noiseGradientDensity(densityFunction3, NoiseRouterData.offsetToDepth(densityFunction4)), DensityFunctions.constant(-0.703125)).clamp(-64.0, 64.0)), DensityFunctions.constant(-0.390625));
        return DensityFunctions.findTopSurface(densityFunction6, densityFunction5, -64, NoiseSettings.OVERWORLD_NOISE_SETTINGS.getCellHeight());
    }
