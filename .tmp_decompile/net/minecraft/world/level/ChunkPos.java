...
public class ChunkPos {
    public static final Codec<ChunkPos> CODEC = Codec.INT_STREAM.comapFlatMap(intStream -> Util.fixedSize(intStream, 2).map(is -> new ChunkPos(is[0], is[1])), chunkPos -> IntStream.of(chunkPos.x, chunkPos.z)).stable();
    ...
    public static boolean isValid(int i, int j) {
        return Mth.absMax(i, j) <= MAX_COORDINATE_VALUE;
    }
    ...
    public int getChessboardDistance(int i, int j) {
        return Mth.chessboardDistance(i, j, this.x, this.z);
    }
