...
public class StateDefinition<O, S extends StateHolder<O, S>> {
    ...
    protected StateDefinition(Function<O, S> function, O object, Factory<O, S> factory, Map<String, Property<?>> map) {
        ...
        stream.forEach(list2 -> {
            ...
            StateHolder stateHolder = (StateHolder)factory.create(object, reference2ObjectArrayMap, mapCodec2);
            map2.put(reference2ObjectArrayMap, stateHolder);
    ...
    public static class Builder<O, S extends StateHolder<O, S>> {
        ...
        private <T extends Comparable<T>> void validateProperty(Property<T> property) {
            ...
            List<T> collection = property.getPossibleValues();
