...
public class MultifaceSpreader {
    ...
    public Optional<SpreadPos> spreadFromFaceTowardDirection(BlockState blockState, LevelAccessor levelAccessor, BlockPos blockPos, Direction direction, Direction direction2, boolean bl) {
        return this.getSpreadFromFaceTowardDirection(blockState, levelAccessor, blockPos, direction, direction2, this.config::canSpreadInto).flatMap(spreadPos -> this.spreadToFace(levelAccessor, (SpreadPos)((Object)spreadPos), bl));
    }
