...
implements BonemealableBlock {
    ...
    public void performBonemeal(ServerLevel serverLevel, RandomSource randomSource, BlockPos blockPos, BlockState blockState) {
        ...
        block0: for (int i = 0; i < 128; ++i) {
            ...
            if (blockState3.is(blockState2.getBlock()) && randomSource.nextInt(10) == 0 && (bonemealableBlock = (BonemealableBlock)((Object)blockState2.getBlock())).isValidBonemealTarget(serverLevel, blockPos3, blockState3)) {
            ...
            ((PlacedFeature)((Object)holder.value())).place(serverLevel, serverLevel.getChunkSource().getGenerator(), randomSource, blockPos3);
        }
    }
