...
public class ChunkGeneratorStructureState {
    ...
    public static ChunkGeneratorStructureState createForFlat(RandomState randomState, long l, BiomeSource biomeSource, Stream<Holder<StructureSet>> stream) {
        List list = stream.filter(holder -> ChunkGeneratorStructureState.hasBiomesForStructureSet((StructureSet)((Object)((Object)holder.value())), biomeSource)).toList();
    ...
    public static ChunkGeneratorStructureState createForNormal(RandomState randomState, long l, BiomeSource biomeSource, HolderLookup<StructureSet> holderLookup) {
        List list = (List)holderLookup.listElements().filter(reference -> ChunkGeneratorStructureState.hasBiomesForStructureSet((StructureSet)((Object)((Object)reference.value())), biomeSource)).collect(Collectors.toUnmodifiableList());
    ...
    private void generatePositions() {
        ...
        this.possibleStructureSets().forEach(holder -> {
            ...
            StructureSet structureSet = (StructureSet)((Object)((Object)holder.value()));
            boolean bl = false;
