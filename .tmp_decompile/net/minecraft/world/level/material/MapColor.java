...
public class MapColor {
    ...
    private MapColor(int i, int j) {
        ...
        this.id = i;
        this.col = j;
        MapColor.MATERIAL_COLORS[i] = this;
    }
    ...
    public static MapColor byId(int i) {
        Preconditions.checkPositionIndex((int)i, (int)MATERIAL_COLORS.length, (String)"material id");
        return MapColor.byIdUnsafe(i);
    }
    ...
    public static int getColorFromPackedId(int i) {
        int j = i & 0xFF;
        return MapColor.byIdUnsafe(j >> 2).calculateARGBColor(Brightness.byIdUnsafe(j & 3));
    }
    ...
    public static enum Brightness {
        ...
        public static Brightness byId(int i) {
            Preconditions.checkPositionIndex((int)i, (int)VALUES.length, (String)"brightness id");
