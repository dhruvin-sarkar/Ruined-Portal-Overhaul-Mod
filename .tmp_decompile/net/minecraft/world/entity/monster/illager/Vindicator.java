...
extends AbstractIllager {
    ...
    public void applyRaidBuffs(ServerLevel serverLevel, int i, boolean bl) {
        ...
        if (bl2) {
            ResourceKey<EnchantmentProvider> resourceKey = i > raid.getNumGroups(Difficulty.NORMAL) ? VanillaEnchantmentProviders.RAID_VINDICATOR_POST_WAVE_5 : VanillaEnchantmentProviders.RAID_VINDICATOR;
