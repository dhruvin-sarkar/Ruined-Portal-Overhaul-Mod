...
implements RangedAttackMob {
    ...
    protected void travelInWater(Vec3 vec3, double d, boolean bl, double e) {
        if (this.isUnderWater() && this.wantsToSwim()) {
            ...
            super.travelInWater(vec3, d, bl, e);
        }
    }
    ...
    public void performRangedAttack(LivingEntity livingEntity, float f) {
        ...
        if (level instanceof ServerLevel) {
            ...
            Projectile.spawnProjectileUsingShoot(thrownTrident, serverLevel, itemStack2, d, e + h * (double)0.2f, g, 1.6f, 14 - this.level().getDifficulty().getId() * 4);
        }
