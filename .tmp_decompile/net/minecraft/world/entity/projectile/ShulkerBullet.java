...
extends Projectile {
    ...
    public ShulkerBullet(Level level, LivingEntity livingEntity, Entity entity, Direction.Axis axis) {
        ...
        this.finalTarget = EntityReference.of(entity);
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (bl) {
            ...
            if (entity instanceof LivingEntity) {
                ...
                livingEntity2.addEffect(new MobEffectInstance(MobEffects.LEVITATION, 200), (Entity)MoreObjects.firstNonNull((Object)entity2, (Object)this));
            }
        }
    }
