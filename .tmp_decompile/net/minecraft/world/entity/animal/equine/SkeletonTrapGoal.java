...
extends Goal {
    ...
    private @Nullable AbstractHorse createHorse(DifficultyInstance difficultyInstance) {
    ...
    private @Nullable Skeleton createSkeleton(DifficultyInstance difficultyInstance, AbstractHorse abstractHorse) {
