...
public record WolfSoundVariant(Holder<SoundEvent> ambientSound, Holder<SoundEvent> deathSound, Holder<SoundEvent> growlSound, Holder<SoundEvent> hurtSound, Holder<SoundEvent> pantSound, Holder<SoundEvent> whineSound) {
    ...
    private static Codec<WolfSoundVariant> getWolfSoundVariantCodec() {
        return RecordCodecBuilder.create(instance -> instance.group((App)SoundEvent.CODEC.fieldOf("ambient_sound").forGetter(WolfSoundVariant::ambientSound), (App)SoundEvent.CODEC.fieldOf("death_sound").forGetter(WolfSoundVariant::deathSound), (App)SoundEvent.CODEC.fieldOf("growl_sound").forGetter(WolfSoundVariant::growlSound), (App)SoundEvent.CODEC.fieldOf("hurt_sound").forGetter(WolfSoundVariant::hurtSound), (App)SoundEvent.CODEC.fieldOf("pant_sound").forGetter(WolfSoundVariant::pantSound), (App)SoundEvent.CODEC.fieldOf("whine_sound").forGetter(WolfSoundVariant::whineSound)).apply((Applicative)instance, WolfSoundVariant::new));
    }
}
