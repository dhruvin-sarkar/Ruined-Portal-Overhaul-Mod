...
extends AbstractHorse {
    ...
    protected Vec3 getPassengerAttachmentPoint(Entity entity, EntityDimensions entityDimensions, float f) {
        ...
        boolean bl = i == 0;
        float g = 0.5f;
        float h = (float)(this.isRemoved() ? (double)0.01f : this.getBodyAnchorAnimationYOffset(bl, 0.0f, entityDimensions, f));
        ...
        return new Vec3(0.0, h, g * f).yRot(-this.getYRot() * ((float)Math.PI / 180));
    }
    ...
    private double getBodyAnchorAnimationYOffset(boolean bl, float f, EntityDimensions entityDimensions, float g) {
        double d = entityDimensions.height() - 0.375f * g;
        float h = g * 1.43f;
        float i = h - g * 0.2f;
        float j = h - i;
        ...
        if (bl2) {
            ...
            float n2 = Mth.clamp((float)this.getPoseTime() + f, 0.0f, (float)k);
    ...
    public Vec3 getLeashOffset(float f) {
        ...
        return new Vec3(0.0, this.getBodyAnchorAnimationYOffset(true, f, entityDimensions, g) - (double)(0.2f * g), entityDimensions.width() * 0.56f);
    }
