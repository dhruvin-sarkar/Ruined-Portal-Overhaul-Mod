...
extends Animal {
    ...
    private void setServerStillTimeout(int i) {
        Level level;
        if (this.serverStillTimeout <= 0 && i > 0 && (level = this.level()) instanceof ServerLevel) {
    ...
    protected Vec3 getRiddenInput(Player player, Vec3 vec3) {
        ...
        return new Vec3(f, h, g).scale((double)3.9f * this.getAttributeValue(Attributes.FLYING_SPEED));
    }
    ...
    private void continuousHeal() {
        ...
        boolean bl = this.isInClouds() || serverLevel.precipitationAt(this.blockPosition()) != Biome.Precipitation.NONE;
    ...
    extends LookControl {
        ...
        public void tick() {
            ...
            if (this.lookAtCooldown > 0) {
                ...
                HappyGhast.this.setYRot(-((float)Mth.atan2(d, e)) * 57.295776f);
