...
extends Animal {
    ...
    @Override
    public @Nullable Ocelot getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
    ...
    extends AvoidEntityGoal<T> {
        ...
        public OcelotAvoidEntityGoal(Ocelot ocelot, Class<T> class_, float f, double d, double e) {
            super(ocelot, class_, f, d, e, EntitySelector.NO_CREATIVE_OR_SPECTATOR);
            this.ocelot = ocelot;
        }
