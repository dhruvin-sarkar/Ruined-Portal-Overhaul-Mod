...
VibrationSystem {
    ...
    public boolean wantsToPickUp(ServerLevel serverLevel, ItemStack itemStack) {
        ItemStack itemStack2 = this.getItemInHand(InteractionHand.MAIN_HAND);
        return !itemStack2.isEmpty() && serverLevel.getGameRules().get(GameRules.MOB_GRIEFING) != false && this.inventory.canAddItem(itemStack) && this.allayConsidersItemEqual(itemStack2, itemStack);
    }
    ...
    private boolean hasNonMatchingPotion(ItemStack itemStack, ItemStack itemStack2) {
        ...
        return !Objects.equals(potionContents, potionContents2 = itemStack2.get(DataComponents.POTION_CONTENTS));
    }
