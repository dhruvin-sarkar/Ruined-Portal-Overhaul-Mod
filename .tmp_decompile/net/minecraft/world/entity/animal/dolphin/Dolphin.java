...
extends AgeableWaterCreature {
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor serverLevelAccessor, DifficultyInstance difficultyInstance, EntitySpawnReason entitySpawnReason, @Nullable SpawnGroupData spawnGroupData) {
        ...
        this.setXRot(0.0f);
        SpawnGroupData spawnGroupData2 = (SpawnGroupData)Objects.requireNonNullElseGet((Object)spawnGroupData, () -> new AgeableMob.AgeableMobGroupData(0.1f));
        return super.finalizeSpawn(serverLevelAccessor, difficultyInstance, entitySpawnReason, spawnGroupData2);
    }

    @Override
    public @Nullable Dolphin getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
