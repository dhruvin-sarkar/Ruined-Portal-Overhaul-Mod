...
public class GossipContainer {
    ...
    private Collection<GossipEntry> selectGossipsForTransfer(RandomSource randomSource, int i) {
        ...
        for (int k = 0; k < list.size(); ++k) {
            GossipEntry gossipEntry = (GossipEntry)((Object)list.get(k));
        ...
        for (int l = 0; l < i; ++l) {
            ...
            set.add((GossipEntry)((Object)list.get(n < 0 ? -n - 1 : n)));
        }
        return set;
    }
    ...
    public void transferFrom(GossipContainer gossipContainer, RandomSource randomSource, int i) {
        ...
        collection.forEach(gossipEntry -> {
            ...
            if (i >= 2) {
                this.getOrCreate((UUID)gossipEntry.target).entries.mergeInt((Object)gossipEntry.type, i, GossipContainer::mergeValuesForTransfer);
            }
        });
    }
    ...
    public void add(UUID uUID, GossipType gossipType, int i2) {
        ...
        entityGossips.entries.mergeInt((Object)gossipType, i2, (i, j) -> this.mergeValuesForAddition(gossipType, i, j));
