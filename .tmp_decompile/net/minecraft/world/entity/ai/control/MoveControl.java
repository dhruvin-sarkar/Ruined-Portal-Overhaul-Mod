...
implements Control {
    ...
    private boolean isWalkable(float f, float g) {
        ...
        return pathNavigation == null || (nodeEvaluator = pathNavigation.getNodeEvaluator()) == null || nodeEvaluator.getPathType(this.mob, BlockPos.containing(this.mob.getX() + (double)f, this.mob.getBlockY(), this.mob.getZ() + (double)g)) == PathType.WALKABLE;
    }
