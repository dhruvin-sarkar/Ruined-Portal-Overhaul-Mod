...
public class BehaviorUtils {
    ...
    public static void lockGazeAndWalkToEachOther(LivingEntity livingEntity, LivingEntity livingEntity2, float f, int i) {
        ...
        BehaviorUtils.setWalkAndLookTargetMemoriesToEachOther(livingEntity, livingEntity2, f, i);
    }
    ...
    private static void setWalkAndLookTargetMemoriesToEachOther(LivingEntity livingEntity, LivingEntity livingEntity2, float f, int i) {
        BehaviorUtils.setWalkAndLookTargetMemories(livingEntity, livingEntity2, f, i);
        BehaviorUtils.setWalkAndLookTargetMemories(livingEntity2, livingEntity, f, i);
    }
    ...
    public static Optional<LivingEntity> getLivingEntityFromUUIDMemory(LivingEntity livingEntity, MemoryModuleType<UUID> memoryModuleType) {
        ...
        return optional.map(uUID -> livingEntity.level().getEntity((UUID)uUID)).map(entity -> {
            LivingEntity livingEntity;
            return entity instanceof LivingEntity ? (livingEntity = (LivingEntity)entity) : null;
        });
    }

    public static @Nullable Vec3 getRandomSwimmablePos(PathfinderMob pathfinderMob, int i, int j) {
