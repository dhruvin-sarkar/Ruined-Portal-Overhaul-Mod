...
implements App<Mu<E>, M> {
    ...
    extends BehaviorBuilder<E, Unit> {
        TriggerWrapper(final Trigger<? super E> trigger) {
            super(new TriggerWithResult<E, Unit>(){
                ...
                @Override
                public @Nullable Unit tryTrigger(ServerLevel serverLevel, E livingEntity, long l) {
                ...
                @Override
                public /* synthetic */ @Nullable Object tryTrigger(ServerLevel serverLevel, LivingEntity livingEntity, long l) {
    ...
    extends BehaviorBuilder<E, A> {
        Constant(A object) {
            this(object, () -> "C[" + String.valueOf(object) + "]");
        }
    ...
    extends BehaviorBuilder<E, MemoryAccessor<F, Value>> {
        PureMemory(final MemoryCondition<F, Value> memoryCondition) {
            super(new TriggerWithResult<E, MemoryAccessor<F, Value>>(){
                ...
                @Override
                public @Nullable MemoryAccessor<F, Value> tryTrigger(ServerLevel serverLevel, E livingEntity, long l) {
