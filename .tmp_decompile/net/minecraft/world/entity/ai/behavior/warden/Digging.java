...
extends Behavior<E> {
    public Digging(int i) {
        super((Map<MemoryModuleType<?>, MemoryStatus>)ImmutableMap.of(MemoryModuleType.ATTACK_TARGET, (Object)((Object)MemoryStatus.VALUE_ABSENT), MemoryModuleType.WALK_TARGET, (Object)((Object)MemoryStatus.VALUE_ABSENT)), i);
    }
    ...
    protected boolean checkExtraStartConditions(ServerLevel serverLevel, E warden) {
        return ((Entity)warden).onGround() || ((Entity)warden).isInWater() || ((Entity)warden).isInLava();
    }

    @Override
    protected void start(ServerLevel serverLevel, E warden, long l) {
        if (((Entity)warden).onGround()) {
