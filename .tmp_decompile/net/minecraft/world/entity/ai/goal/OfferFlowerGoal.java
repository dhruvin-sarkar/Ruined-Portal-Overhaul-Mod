...
extends Goal {
    ...
    public void stop() {
        ...
        if (this.tick == 0 && (livingEntity = this.entity) instanceof Mob && (mob = (Mob)livingEntity).getType().is(EntityTypeTags.ACCEPTS_IRON_GOLEM_GIFT) && mob.getItemBySlot(CopperGolem.EQUIPMENT_SLOT_ANTENNA).isEmpty() && this.getGolemBoundingBox().intersects(mob.getBoundingBox())) {
