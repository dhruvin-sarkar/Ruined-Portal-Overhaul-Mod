...
extends Goal {
    ...
    public AvoidEntityGoal(PathfinderMob pathfinderMob, Class<T> class_, float f, double d, double e) {
        this(pathfinderMob, class_, livingEntity -> true, f, d, e, EntitySelector.NO_CREATIVE_OR_SPECTATOR);
    }

    public AvoidEntityGoal(PathfinderMob pathfinderMob, Class<T> class_, Predicate<LivingEntity> predicate, float f, double d, double e, Predicate<? super LivingEntity> predicate2) {
    ...
    public AvoidEntityGoal(PathfinderMob pathfinderMob, Class<T> class_, float f, double d, double e, Predicate<? super LivingEntity> predicate) {
