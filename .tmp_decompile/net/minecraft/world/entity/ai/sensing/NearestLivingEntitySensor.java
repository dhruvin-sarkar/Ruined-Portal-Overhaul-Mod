...
extends Sensor<T> {
    ...
    protected void doTick(ServerLevel serverLevel, T livingEntity) {
        ...
        AABB aABB = ((Entity)livingEntity).getBoundingBox().inflate(d, d, d);
        ...
        brain.setMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES, new NearestVisibleLivingEntities(serverLevel, (LivingEntity)livingEntity, list));
    }
