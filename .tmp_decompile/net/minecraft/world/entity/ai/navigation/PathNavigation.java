...
public abstract class PathNavigation {
    ...
    public final @Nullable Path createPath(double d, double e, double f, int i) {
        return this.createPath(BlockPos.containing(d, e, f), i);
    }

    public @Nullable Path createPath(Stream<BlockPos> stream, int i) {
        return this.createPath(stream.collect(Collectors.toSet()), 8, false, i);
    }

    public @Nullable Path createPath(Set<BlockPos> set, int i) {
        return this.createPath(set, 8, false, i);
    }

    public @Nullable Path createPath(BlockPos blockPos, int i) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)blockPos), 8, false, i);
    }

    public @Nullable Path createPath(BlockPos blockPos, int i, int j) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)blockPos), 8, false, i, j);
    }

    public @Nullable Path createPath(Entity entity, int i) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)entity.blockPosition()), 16, true, i);
    }

    protected @Nullable Path createPath(Set<BlockPos> set, int i, boolean bl, int j) {
        return this.createPath(set, i, bl, j, this.getMaxPathLength());
    }

    protected @Nullable Path createPath(Set<BlockPos> set, int i, boolean bl, int j, float f) {
        if (set.isEmpty()) {
            return null;
        }
