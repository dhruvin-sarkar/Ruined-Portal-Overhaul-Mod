...
public class PoiSection {
    ...
    public @Nullable PoiRecord add(BlockPos blockPos, Holder<PoiType> holder) {
        PoiRecord poiRecord = new PoiRecord(blockPos, holder, this.setDirty);
    ...
    public Optional<DebugPoiInfo> getDebugPoiInfo(BlockPos blockPos) {
        return this.getPoiRecord(blockPos).map(DebugPoiInfo::new);
    }
    ...
    private /* synthetic */ void method_20352(Short2ObjectMap short2ObjectMap, BlockPos blockPos, Holder holder) {
