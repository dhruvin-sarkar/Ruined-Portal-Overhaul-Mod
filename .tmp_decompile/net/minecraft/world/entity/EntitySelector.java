...
public final class EntitySelector {
    ...
    public static Predicate<Entity> withinDistance(double d, double e, double f, double g) {
        double h = g * g;
        return entity -> entity.distanceToSqr(d, e, f) <= h;
    }

    public static Predicate<Entity> pushableBy(Entity entity) {
        Team.CollisionRule collisionRule;
        PlayerTeam team = entity.getTeam();
        Team.CollisionRule collisionRule2 = collisionRule = team == null ? Team.CollisionRule.ALWAYS : ((Team)team).getCollisionRule();
        ...
        return NO_SPECTATORS.and(entity2 -> {
            ...
            if (!(!entity.level().isClientSide() || entity2 instanceof Player && (player = (Player)entity2).isLocalPlayer())) {
                return false;
            }
            PlayerTeam team2 = entity2.getTeam();
            Team.CollisionRule collisionRule3 = collisionRule2 = team2 == null ? Team.CollisionRule.ALWAYS : ((Team)team2).getCollisionRule();
