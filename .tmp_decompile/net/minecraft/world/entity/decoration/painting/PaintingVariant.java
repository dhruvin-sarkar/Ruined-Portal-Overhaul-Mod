...
public record PaintingVariant(int width, int height, Identifier assetId, Optional<Component> title, Optional<Component> author) {
    public static final Codec<PaintingVariant> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ExtraCodecs.intRange(1, 16).fieldOf("width").forGetter(PaintingVariant::width), (App)ExtraCodecs.intRange(1, 16).fieldOf("height").forGetter(PaintingVariant::height), (App)Identifier.CODEC.fieldOf("asset_id").forGetter(PaintingVariant::assetId), (App)ComponentSerialization.CODEC.optionalFieldOf("title").forGetter(PaintingVariant::title), (App)ComponentSerialization.CODEC.optionalFieldOf("author").forGetter(PaintingVariant::author)).apply((Applicative)instance, PaintingVariant::new));
