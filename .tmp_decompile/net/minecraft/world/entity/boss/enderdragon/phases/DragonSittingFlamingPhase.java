    ...
    public void doClientTick() {
        ...
        if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int k = 0; k < 6; ++k) {
                    this.dragon.level().addParticle(PowerParticleOption.create(ParticleTypes.DRAGON_BREATH, 1.0f), g, h, j, -vec3.x * (double)0.08f * (double)k, -vec3.y * (double)0.6f, -vec3.z * (double)0.08f * (double)k);
                }
