...
implements TestReporter {
    ...
    private Element createTestCase(GameTestInfo gameTestInfo, String string) {
        ...
        element.setAttribute("classname", gameTestInfo.getStructure().toString());
    ...
    public void onTestFailed(GameTestInfo gameTestInfo) {
        String string = gameTestInfo.id().toString();
        ...
        element.setAttribute("message", "(" + gameTestInfo.getTestBlockPos().toShortString() + ") " + string2);
