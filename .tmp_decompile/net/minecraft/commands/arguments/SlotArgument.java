...
implements ArgumentType<Integer> {
    ...
    private static final DynamicCommandExceptionType ERROR_ONLY_SINGLE_SLOT_ALLOWED = new DynamicCommandExceptionType(object -> Component.translatableEscape("slot.only_single_allowed", object));
    ...
    public Integer parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        if (slotRange.size() != 1) {
            throw ERROR_ONLY_SINGLE_SLOT_ALLOWED.createWithContext((ImmutableStringReader)stringReader, (Object)string);
        }
