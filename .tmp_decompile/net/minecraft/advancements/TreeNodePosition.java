...
public class TreeNodePosition {
    ...
    public TreeNodePosition(AdvancementNode advancementNode, @Nullable TreeNodePosition treeNodePosition, @Nullable TreeNodePosition treeNodePosition2, int i, int j) {
    ...
    private @Nullable TreeNodePosition addChild(AdvancementNode advancementNode, @Nullable TreeNodePosition treeNodePosition) {
