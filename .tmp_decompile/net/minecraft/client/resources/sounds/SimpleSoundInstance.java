...
extends AbstractSoundInstance {
    ...
    public static SimpleSoundInstance forMusic(SoundEvent soundEvent) {
        return new SimpleSoundInstance(soundEvent.location(), SoundSource.MUSIC, 1.0f, 1.0f, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0, 0.0, 0.0, true);
    }
    ...
    public SimpleSoundInstance(Identifier identifier, SoundSource soundSource, float f, float g, RandomSource randomSource, boolean bl, int i, SoundInstance.Attenuation attenuation, double d, double e, double h, boolean bl2) {
        super(identifier, soundSource, randomSource);
        this.volume = f;
        this.pitch = g;
        this.x = d;
        this.y = e;
