...
public abstract class Particle {
    ...
    public Particle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i) {
        ...
        this.xd = g + (double)((this.random.nextFloat() * 2.0f - 1.0f) * 0.4f);
        this.yd = h + (double)((this.random.nextFloat() * 2.0f - 1.0f) * 0.4f);
        this.zd = i + (double)((this.random.nextFloat() * 2.0f - 1.0f) * 0.4f);
        double j = (this.random.nextFloat() + this.random.nextFloat() + 1.0f) * 0.15f;
    ...
    public record LifetimeAlpha(float startAlpha, float endAlpha, float startAtNormalizedAge, float endAtNormalizedAge) {
        ...
        public float currentAlphaForAge(int i, int j, float f) {
            ...
            return Mth.clampedLerp(g, this.startAlpha, this.endAlpha);
        }
    }
}
