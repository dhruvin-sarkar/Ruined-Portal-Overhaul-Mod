...
extends SingleQuadParticle {
    ...
    implements ParticleProvider<PowerParticleOption> {
        ...
        @Override
        public Particle createParticle(PowerParticleOption powerParticleOption, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DragonBreathParticle dragonBreathParticle = new DragonBreathParticle(clientLevel, d, e, f, g, h, i, this.sprites);
            dragonBreathParticle.setPower(powerParticleOption.getPower());
