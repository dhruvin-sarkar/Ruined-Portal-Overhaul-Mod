...
extends SingleQuadParticle {
    ...
    protected SnowflakeParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, SpriteSet spriteSet) {
        ...
        this.xd = g + (double)((this.random.nextFloat() * 2.0f - 1.0f) * 0.05f);
        this.yd = h + (double)((this.random.nextFloat() * 2.0f - 1.0f) * 0.05f);
        this.zd = i + (double)((this.random.nextFloat() * 2.0f - 1.0f) * 0.05f);
