...
extends SingleQuadParticle {
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            ...
            int j = 10;
            int k = 40;
            glowParticle.setLifetime(randomSource.nextInt(30) + 10);
            return glowParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            ...
            int j = 2;
            int k = 4;
            glowParticle.setLifetime(randomSource.nextInt(2) + 2);
            return glowParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            GlowParticle glowParticle = new GlowParticle(clientLevel, d, e, f, 0.5 - randomSource.nextDouble(), h, 0.5 - randomSource.nextDouble(), this.sprite);
            if (randomSource.nextBoolean()) {
            ...
            glowParticle.setLifetime((int)(8.0 / (randomSource.nextDouble() * 0.8 + 0.2)));
            return glowParticle;
        }
    }
}
