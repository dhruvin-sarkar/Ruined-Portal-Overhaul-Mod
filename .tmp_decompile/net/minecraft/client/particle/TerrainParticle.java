...
extends SingleQuadParticle {
    ...
    static @Nullable TerrainParticle createTerrainParticle(BlockParticleOption blockParticleOption, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i) {
    ...
    implements ParticleProvider<BlockParticleOption> {
        @Override
        public @Nullable Particle createParticle(BlockParticleOption blockParticleOption, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            TerrainParticle particle = TerrainParticle.createTerrainParticle(blockParticleOption, clientLevel, d, e, f, g, h, i);
            if (particle != null) {
