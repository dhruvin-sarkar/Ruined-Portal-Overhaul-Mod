...
public class SuffixArray<T> {
    ...
    public void add(T object, String string) {
        ...
        for (int j = 0; j < string.length(); ++j) {
            ...
            this.offsets.add(j);
            this.chars.add((int)string.charAt(j));
        }
        this.suffixToT.add(i);
    ...
    public List<T> search(String string) {
        ...
        while (j < k) {
            ...
            if (DEBUG_COMPARISONS) {
                LOGGER.debug("comparing lower \"{}\" with {} \"{}\": {}", new Object[]{string, l, this.getString(l), m});
            }
            if (m > 0) {
                j = l + 1;
                continue;
        ...
        while (j < k) {
            ...
            if (DEBUG_COMPARISONS) {
                LOGGER.debug("comparing upper \"{}\" with {} \"{}\": {}", new Object[]{string, m, this.getString(m), n});
            }
            if (n >= 0) {
                j = m + 1;
                continue;
