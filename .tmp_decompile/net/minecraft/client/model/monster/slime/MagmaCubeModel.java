...
extends EntityModel<SlimeRenderState> {
    ...
    public MagmaCubeModel(ModelPart modelPart) {
        super(modelPart);
        Arrays.setAll(this.bodyCubes, i -> modelPart.getChild(MagmaCubeModel.getSegmentName(i)));
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            partDefinition.addOrReplaceChild(MagmaCubeModel.getSegmentName(i), CubeListBuilder.create().texOffs(j, k).addBox(-4.0f, 16 + i, -4.0f, 8.0f, 1.0f, 8.0f), PartPose.ZERO);
        }
