...
HeadedModel {
    ...
    public void setupAnim(S illagerRenderState) {
        ...
        this.head.yRot = ((IllagerRenderState)illagerRenderState).yRot * ((float)Math.PI / 180);
        this.head.xRot = ((IllagerRenderState)illagerRenderState).xRot * ((float)Math.PI / 180);
        if (((IllagerRenderState)illagerRenderState).isRiding) {
            ...
            float f = ((IllagerRenderState)illagerRenderState).walkAnimationSpeed;
            float g = ((IllagerRenderState)illagerRenderState).walkAnimationPos;
        ...
        AbstractIllager.IllagerArmPose illagerArmPose = ((IllagerRenderState)illagerRenderState).armPose;
        if (illagerArmPose == AbstractIllager.IllagerArmPose.ATTACKING) {
            if (((ArmedEntityRenderState)illagerRenderState).getMainHandItemState().isEmpty()) {
                AnimationUtils.animateZombieArms(this.leftArm, this.rightArm, true, illagerRenderState);
            } else {
                AnimationUtils.swingWeaponDown(this.rightArm, this.leftArm, ((IllagerRenderState)illagerRenderState).mainArm, ((IllagerRenderState)illagerRenderState).attackAnim, ((IllagerRenderState)illagerRenderState).ageInTicks);
            }
            ...
            this.leftArm.z = 0.0f;
            this.leftArm.x = 5.0f;
            this.rightArm.xRot = Mth.cos(((IllagerRenderState)illagerRenderState).ageInTicks * 0.6662f) * 0.25f;
            this.leftArm.xRot = Mth.cos(((IllagerRenderState)illagerRenderState).ageInTicks * 0.6662f) * 0.25f;
            ...
            AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, ((IllagerRenderState)illagerRenderState).maxCrossbowChargeDuration, ((IllagerRenderState)illagerRenderState).ticksUsingItem, true);
        } else if (illagerArmPose == AbstractIllager.IllagerArmPose.CELEBRATING) {
            this.rightArm.z = 0.0f;
            this.rightArm.x = -5.0f;
            this.rightArm.xRot = Mth.cos(((IllagerRenderState)illagerRenderState).ageInTicks * 0.6662f) * 0.05f;
            this.rightArm.zRot = 2.670354f;
            this.rightArm.yRot = 0.0f;
            this.leftArm.z = 0.0f;
            this.leftArm.x = 5.0f;
            this.leftArm.xRot = Mth.cos(((IllagerRenderState)illagerRenderState).ageInTicks * 0.6662f) * 0.05f;
            this.leftArm.zRot = -2.3561945f;
            this.leftArm.yRot = 0.0f;
        }
    ...
    @Override
    public void translateToHand(IllagerRenderState illagerRenderState, HumanoidArm humanoidArm, PoseStack poseStack) {
