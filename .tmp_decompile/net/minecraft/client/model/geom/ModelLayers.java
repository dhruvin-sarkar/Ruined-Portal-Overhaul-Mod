...
public class ModelLayers {
    ...
    public static final ModelLayerLocation CAMEL_HUSK_BABY_SADDLE = ModelLayers.register("camel_husk_baby", "saddle");
    ...
    public static final ModelLayerLocation UNDEAD_HORSE_BABY_ARMOR = ModelLayers.register("undead_horse_baby_armor");
    ...
    private static ModelLayerLocation register(String string, String string2) {
        ...
        if (!ALL_MODELS.add(modelLayerLocation)) {
            throw new IllegalStateException("Duplicate registration for " + String.valueOf((Object)modelLayerLocation));
        }
    ...
    private static ArmorModelSet<ModelLayerLocation> registerArmorSet(String string) {
        return new ArmorModelSet<ModelLayerLocation>(ModelLayers.register(string, "helmet"), ModelLayers.register(string, "chestplate"), ModelLayers.register(string, "leggings"), ModelLayers.register(string, "boots"));
    }
