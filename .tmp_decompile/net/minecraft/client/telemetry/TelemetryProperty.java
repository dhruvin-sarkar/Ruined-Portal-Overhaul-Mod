...
public record TelemetryProperty<T>(String id, String exportKey, Codec<T> codec, Exporter<T> exporter) {
    ...
    public static TelemetryProperty<GameLoadTimesEvent.Measurement> gameLoadMeasurement(String string2, String string22) {
        return TelemetryProperty.create(string2, string22, GameLoadTimesEvent.Measurement.CODEC, (telemetryPropertyContainer, string, measurement) -> telemetryPropertyContainer.addProperty(string, measurement.millis()));
    }
