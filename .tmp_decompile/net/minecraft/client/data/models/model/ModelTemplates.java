...
public class ModelTemplates {
    ...
    private static ModelTemplate createItem(String string, TextureSlot ... textureSlots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("item/" + string)), Optional.empty(), textureSlots);
    }

    private static ModelTemplate createItem(String string, String string2, TextureSlot ... textureSlots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("item/" + string)), Optional.of(string2), textureSlots);
    }

    private static ModelTemplate create(String string, String string2, TextureSlot ... textureSlots) {
        return new ModelTemplate(Optional.of(Identifier.withDefaultNamespace("block/" + string)), Optional.of(string2), textureSlots);
    }
}
