...
public class QuickPlayLog {
    ...
    public void log(Minecraft minecraft) {
        ...
        Util.ioPool().execute(() -> {
            ...
            Codec.list(QuickPlayEntry.CODEC).encodeStart((DynamicOps)JsonOps.INSTANCE, (Object)List.of((Object)((Object)quickPlayEntry))).resultOrPartial(Util.prefix("Quick Play: ", arg_0 -> ((Logger)LOGGER).error(arg_0))).ifPresent(jsonElement -> {
                try {
                    Files.createDirectories(this.path.getParent(), new FileAttribute[0]);
                    Files.writeString((Path)this.path, (CharSequence)GSON.toJson(jsonElement), (OpenOption[])new OpenOption[0]);
                }
                catch (IOException iOException) {
