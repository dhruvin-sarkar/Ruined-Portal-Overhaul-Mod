...
public class SpectatorMenu {
    ...
    public SpectatorMenuItem getItem(int i) {
        ...
        return (SpectatorMenuItem)MoreObjects.firstNonNull((Object)this.category.getItems().get(j), (Object)EMPTY_SLOT);
    }
    ...
    implements SpectatorMenuItem {
        ...
        @Override
        public void renderIcon(GuiGraphics guiGraphics, float f, float g) {
            guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, CLOSE_SPRITE, 0, 0, 16, 16, ARGB.colorFromFloat(g, f, f, f));
        }
    ...
    implements SpectatorMenuItem {
        ...
        public void renderIcon(GuiGraphics guiGraphics, float f, float g) {
            ...
            if (this.direction < 0) {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, SCROLL_LEFT_SPRITE, 0, 0, 16, 16, i);
            } else {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, SCROLL_RIGHT_SPRITE, 0, 0, 16, 16, i);
            }
        }
