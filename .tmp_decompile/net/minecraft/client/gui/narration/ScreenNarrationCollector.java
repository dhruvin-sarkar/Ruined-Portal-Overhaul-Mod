...
public class ScreenNarrationCollector {
    ...
    extends Record {
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{EntryKey.class, "type;depth", "type", "depth"}, this);
        }

        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{EntryKey.class, "type;depth", "type", "depth"}, this);
        }

        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{EntryKey.class, "type;depth", "type", "depth"}, this, object);
        }
