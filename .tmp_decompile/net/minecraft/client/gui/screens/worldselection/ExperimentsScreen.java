...
extends Screen {
    ...
    protected void init() {
        ...
        this.packs.forEach((pack, bl) -> builder.addSwitch(ExperimentsScreen.getHumanReadableTitle(pack), () -> this.packs.getBoolean(pack), boolean_ -> this.packs.put(pack, boolean_.booleanValue())).withInfo(pack.getDescription()));
