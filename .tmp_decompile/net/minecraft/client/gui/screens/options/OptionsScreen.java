...
extends Screen {
    ...
    public static CycleButton<Difficulty> createDifficultyButton(int i, int j, String string, Minecraft minecraft) {
        return CycleButton.builder(Difficulty::getDisplayName, minecraft.level.getDifficulty()).withValues((Difficulty[])Difficulty.values()).create(i, j, 150, 20, Component.translatable(string), (cycleButton, difficulty) -> minecraft.getConnection().send(new ServerboundChangeDifficultyPacket((Difficulty)difficulty)));
    }
