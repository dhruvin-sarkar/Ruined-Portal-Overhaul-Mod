...
implements ClientTooltipPositioner {
    ...
    public Vector2ic positionTooltip(int i, int j, int k, int l, int m, int n) {
        ...
        vector2i.y += 3;
        int o = n + 3 + 3;
        int p = this.screenRectangle.bottom() + 3 + MenuTooltipPositioner.getOffset(0, 0, this.screenRectangle.height());
        vector2i.y = p + o <= (q = j - 5) ? (vector2i.y += MenuTooltipPositioner.getOffset(vector2i.y, this.screenRectangle.top(), this.screenRectangle.height())) : (vector2i.y -= o + MenuTooltipPositioner.getOffset(vector2i.y, this.screenRectangle.bottom(), this.screenRectangle.height()));
        return vector2i;
    }
