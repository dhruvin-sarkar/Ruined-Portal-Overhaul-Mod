...
extends AbstractContainerScreen<ChestMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float f, int i, int j) {
        ...
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, CONTAINER_BACKGROUND, k, l, 0.0f, 0.0f, this.imageWidth, this.containerRows * 18 + 17, 256, 256);
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, CONTAINER_BACKGROUND, k, l + this.containerRows * 18 + 17, 0.0f, 126.0f, this.imageWidth, 96, 256, 256);
    }
}
