...
extends Screen {
    ...
    protected void init() {
        ...
        this.jointButton = this.addRenderableWidget(CycleButton.builder(JigsawBlockEntity.JointType::getTranslatedName, this.joint).withValues((JigsawBlockEntity.JointType[])JigsawBlockEntity.JointType.values()).displayOnlyValue().create(this.width / 2 + 54, 160, 100, 20, JOINT_LABEL, (cycleButton, jointType) -> {
        ...
        this.addRenderableWidget(CycleButton.onOffBuilder(this.keepJigsaws).create(this.width / 2 - 50, 185, 100, 20, Component.translatable("jigsaw_block.keep_jigsaws"), (cycleButton, boolean_) -> {
    ...
    private void updateValidity() {
        boolean bl;
        this.doneButton.active = bl = JigsawBlockEditScreen.isValidIdentifier(this.nameEdit.getValue()) && JigsawBlockEditScreen.isValidIdentifier(this.targetEdit.getValue()) && JigsawBlockEditScreen.isValidIdentifier(this.poolEdit.getValue());
    ...
    public boolean keyPressed(KeyEvent keyEvent) {
        ...
        if (this.doneButton.active && keyEvent.isConfirmation()) {
            this.onDone();
            return true;
        }
        return false;
