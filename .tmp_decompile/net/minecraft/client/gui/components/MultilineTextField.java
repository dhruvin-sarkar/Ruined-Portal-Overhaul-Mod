...
public class MultilineTextField {
    ...
    public void selectWordAtCursor() {
        ...
        this.seekCursor(Whence.ABSOLUTE, stringView.endIndex);
    }

    public boolean keyPressed(KeyEvent keyEvent) {
        this.selecting = keyEvent.hasShiftDown();
    ...
    private String truncateInsertionText(String string) {
        ...
        if (this.hasCharacterLimit()) {
            ...
            string2 = StringUtil.truncateStringIfNecessary(string, i, false);
        }
        return string2;
    }
    ...
    extends Record {
        ...
        protected StringView(int i, int j) {
            this.beginIndex = i;
            this.endIndex = j;
        }
