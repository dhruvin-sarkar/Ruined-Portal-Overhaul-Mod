...
public class BlockTintCache {
        ...
        try {
            ...
            for (int k = -1; k <= 1; ++k) {
                for (int l = -1; l <= 1; ++l) {
                    ...
                    CacheData cacheData = (CacheData)this.cache.remove(m);
    ...
    private CacheData findOrCreateChunkCache(int i, int j) {
        ...
        try {
            ...
            this.cache.put(l, (Object)cacheData2);
    ...
    static class CacheData {
        ...
        public int[] getLayer(int i2) {
            ...
            this.lock.writeLock().lock();
            try {
                int[] nArray = (int[])this.cache.computeIfAbsent(i2, i -> this.allocateLayer());
                return nArray;
            }
            finally {
                this.lock.writeLock().unlock();
