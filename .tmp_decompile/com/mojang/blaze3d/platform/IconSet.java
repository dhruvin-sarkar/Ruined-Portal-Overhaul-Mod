...
public enum IconSet {
    ...
    private IoSupplier<InputStream> getFile(PackResources packResources, String string) throws IOException {
        CharSequence[] strings = (String[])ArrayUtils.add((Object[])this.path, (Object)string);
        IoSupplier<InputStream> ioSupplier = packResources.getRootResource((String[])strings);
        if (ioSupplier == null) {
