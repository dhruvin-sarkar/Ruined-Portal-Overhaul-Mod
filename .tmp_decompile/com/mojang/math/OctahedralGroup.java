...
public enum OctahedralGroup implements StringRepresentable
{
    ...
    static {
        ...
        CAYLEY_TABLE = Util.make(() -> {
            OctahedralGroup[] octahedralGroups = OctahedralGroup.values();
            OctahedralGroup[][] octahedralGroups2 = new OctahedralGroup[octahedralGroups.length][octahedralGroups.length];
            Map<Integer, OctahedralGroup> map = Arrays.stream(octahedralGroups).collect(Collectors.toMap(OctahedralGroup::trace, octahedralGroup -> octahedralGroup));
            for (OctahedralGroup octahedralGroup2 : octahedralGroups) {
                for (OctahedralGroup octahedralGroup22 : octahedralGroups) {
                    SymmetricGroup3 symmetricGroup3 = octahedralGroup22.permutation.compose(octahedralGroup2.permutation);
                    boolean bl = octahedralGroup2.inverts(Direction.Axis.X) ^ octahedralGroup22.inverts(octahedralGroup2.permutation.permuteAxis(Direction.Axis.X));
                    boolean bl2 = octahedralGroup2.inverts(Direction.Axis.Y) ^ octahedralGroup22.inverts(octahedralGroup2.permutation.permuteAxis(Direction.Axis.Y));
                    boolean bl3 = octahedralGroup2.inverts(Direction.Axis.Z) ^ octahedralGroup22.inverts(octahedralGroup2.permutation.permuteAxis(Direction.Axis.Z));
                    octahedralGroups2[octahedralGroup2.ordinal()][octahedralGroup22.ordinal()] = map.get(OctahedralGroup.trace(bl, bl2, bl3, symmetricGroup3));
                }
            }
