...
implements RealmsWorldUploadStatusTracker {
    ...
    public RealmsUploadScreen(@Nullable RealmCreationTask realmCreationTask, long l, int i, RealmsResetWorldScreen realmsResetWorldScreen, LevelSummary levelSummary) {
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        if ((components = this.errorMessage) != null) {
    ...
    private void upload() {
        ...
        RealmsWorldUpload realmsWorldUpload = new RealmsWorldUpload(path, realmsSlot = new RealmsSlot(this.slotId, realmsWorldOptions = RealmsWorldOptions.createFromSettings(this.selectedLevel.getSettings(), this.selectedLevel.levelVersion().minecraftVersionName()), List.of((Object)RealmsSetting.hardcoreSetting(this.selectedLevel.getSettings().hardcore()))), this.minecraft.getUser(), this.realmId, this);
